...
#define TIER_TWO 2
        ...
        case _CHECK_PERIODIC: {
            ...
            if (_Py_atomic_load_uintptr_relaxed(&tstate->eval_breaker) & _PY_EVAL_EVENTS_MASK) {
                ...
                if (Py_UNLIKELY(err != 0)) JUMP_TO_ERROR();
            }
            break;
        }
        ...
        case _UNARY_NEGATIVE: {
            ...
            stack_pointer = _PyFrame_GetStackPointer(frame);
            PyStackRef_CLOSE(value);
            if (Py_UNLIKELY(res_o == NULL)) JUMP_TO_ERROR();
        ...
        case _TO_BOOL_LIST: {
            ...
            value = stack_pointer[-1];
            PyObject *value_o = PyStackRef_AsPyObjectBorrow(value);
            if (Py_UNLIKELY(!PyList_CheckExact(value_o))) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
            STAT_INC(TO_BOOL, hit);
        ...
        case _GUARD_BOTH_INT: {
            ...
            if (Py_UNLIKELY(!PyLong_CheckExact(right_o))) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
            break;
        ...
        case _GUARD_BOTH_FLOAT: {
            ...
            if (Py_UNLIKELY(!PyFloat_CheckExact(right_o))) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
            break;
        ...
        case _GUARD_BOTH_UNICODE: {
            ...
            PyObject *left_o = PyStackRef_AsPyObjectBorrow(left);
            PyObject *right_o = PyStackRef_AsPyObjectBorrow(right);
            if (Py_UNLIKELY(!PyUnicode_CheckExact(left_o))) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
            if (Py_UNLIKELY(!PyUnicode_CheckExact(right_o))) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
            break;
        ...
        case _BINARY_OP_INPLACE_ADD_UNICODE: {
            ...
            *target_local = PyStackRef_FromPyObjectSteal(temp);
            PyStackRef_CLOSE_SPECIALIZED(right, _PyUnicode_ExactDealloc);
            if (Py_UNLIKELY(PyStackRef_IsNull(*target_local))) JUMP_TO_ERROR();
            #if TIER_ONE
        ...
        case _STORE_SLICE: {
            ...
            PyStackRef_CLOSE(v);
            PyStackRef_CLOSE(container);
            if (Py_UNLIKELY(err)) JUMP_TO_ERROR();
            stack_pointer += -4;
            assert(WITHIN_STACK_BOUNDS());
            break;
        }
        ...
        case _BINARY_SUBSCR_LIST_INT: {
            ...
            if (Py_UNLIKELY(!PyLong_CheckExact(sub))) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
            if (Py_UNLIKELY(!PyList_CheckExact(list))) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
        ...
        case _BINARY_SUBSCR_STR_INT: {
            ...
            if (Py_UNLIKELY(!PyUnicode_CheckExact(str))) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
            if (Py_UNLIKELY(!_PyLong_IsNonNegativeCompact((PyLongObject *)sub))) {
        ...
        case _BINARY_SUBSCR_TUPLE_INT: {
            ...
            if (Py_UNLIKELY(!PyTuple_CheckExact(tuple))) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
        ...
        case _BINARY_SUBSCR_DICT: {
            ...
            if (Py_UNLIKELY(rc <= 0)) JUMP_TO_ERROR();
            // not found or error
            res = PyStackRef_FromPyObjectSteal(res_o);
            stack_pointer[-2] = res;
            stack_pointer += -1;
        ...
        case _GET_AITER: {
            ...
            stack_pointer = _PyFrame_GetStackPointer(frame);
            PyStackRef_CLOSE(obj);
            if (Py_UNLIKELY(iter_o == NULL)) JUMP_TO_ERROR();
        ...
        case _UNPACK_SEQUENCE: {
            ...
            if (Py_UNLIKELY(res == 0)) JUMP_TO_ERROR();
        ...
        case _UNPACK_SEQUENCE_TWO_TUPLE: {
            ...
            if (Py_UNLIKELY(!PyTuple_CheckExact(seq_o))) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
        ...
        case _UNPACK_SEQUENCE_LIST: {
            ...
            values = &stack_pointer[-1];
            PyObject *seq_o = PyStackRef_AsPyObjectBorrow(seq);
            if (Py_UNLIKELY(!PyList_CheckExact(seq_o))) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
        ...
        case _LOAD_NAME: {
            ...
            stack_pointer = _PyFrame_GetStackPointer(frame);
            if (Py_UNLIKELY(v_o == NULL)) JUMP_TO_ERROR();
        ...
        case _LOAD_GLOBAL: {
            ...
            stack_pointer = _PyFrame_GetStackPointer(frame);
            if (Py_UNLIKELY(PyStackRef_IsNull(*res))) JUMP_TO_ERROR();
        ...
        case _BUILD_STRING: {
            ...
            if (Py_UNLIKELY(str_o == NULL)) JUMP_TO_ERROR();
        ...
        case _BUILD_MAP: {
            ...
            if (Py_UNLIKELY(map_o == NULL)) JUMP_TO_ERROR();
        ...
        case _SETUP_ANNOTATIONS: {
            ...
            if (ann_dict == NULL) {
                ...
                ann_dict = PyDict_New();
                stack_pointer = _PyFrame_GetStackPointer(frame);
                if (Py_UNLIKELY(ann_dict == NULL)) JUMP_TO_ERROR();
                _PyFrame_SetStackPointer(frame, stack_pointer);
        ...
        case _LOAD_SUPER_ATTR_ATTR: {
            ...
            if (Py_UNLIKELY(attr == NULL)) JUMP_TO_ERROR();
        ...
        case _LOAD_ATTR: {
            ...
            if (oparg & 1) {
                ...
                if (is_meth) {
                     ...
                     */
                    PyStackRef_CLOSE(owner);
                    if (Py_UNLIKELY(attr_o == NULL)) JUMP_TO_ERROR();
                    self_or_null = PyStackRef_NULL;
                }
            }
            else {
        ...
        case _COMPARE_OP: {
            ...
            if (oparg & 16) {
                ...
                Py_DECREF(res_o);
                stack_pointer = _PyFrame_GetStackPointer(frame);
                if (Py_UNLIKELY(res_bool < 0)) JUMP_TO_ERROR();
        ...
        case _CONTAINS_OP_SET: {
            ...
            PyObject *left_o = PyStackRef_AsPyObjectBorrow(left);
            PyObject *right_o = PyStackRef_AsPyObjectBorrow(right);
            if (Py_UNLIKELY(!(PySet_CheckExact(right_o) || PyFrozenSet_CheckExact(right_o)))) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
        ...
        case _CONTAINS_OP_DICT: {
            ...
            PyObject *left_o = PyStackRef_AsPyObjectBorrow(left);
            PyObject *right_o = PyStackRef_AsPyObjectBorrow(right);
            if (Py_UNLIKELY(!PyDict_CheckExact(right_o))) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
            STAT_INC(CONTAINS_OP, hit);
        ...
        case _CHECK_EG_MATCH: {
            ...
            if (Py_UNLIKELY(match_o == NULL)) JUMP_TO_ERROR();
        ...
        case _GET_LEN: {
            ...
            stack_pointer = _PyFrame_GetStackPointer(frame);
            if (Py_UNLIKELY(len_i < 0)) JUMP_TO_ERROR();
            PyObject *len_o = PyLong_FromSsize_t(len_i);
            if (Py_UNLIKELY(len_o == NULL)) JUMP_TO_ERROR();
        ...
        case _MATCH_CLASS: {
            ...
            if (attrs_o) {
                ...
                if (Py_UNLIKELY(_PyErr_Occurred(tstate))) JUMP_TO_ERROR();
                // Error!
        ...
        case _MATCH_KEYS: {
            ...
            stack_pointer = _PyFrame_GetStackPointer(frame);
            if (Py_UNLIKELY(values_or_none_o == NULL)) JUMP_TO_ERROR();
        ...
        case _ITER_CHECK_LIST: {
            _PyStackRef iter;
            iter = stack_pointer[-1];
            if (Py_UNLIKELY(Py_TYPE(PyStackRef_AsPyObjectBorrow(iter)) != &PyListIter_Type)) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
            break;
        ...
        case _ITER_CHECK_TUPLE: {
            _PyStackRef iter;
            iter = stack_pointer[-1];
            if (Py_UNLIKELY(Py_TYPE(PyStackRef_AsPyObjectBorrow(iter)) != &PyTupleIter_Type)) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
            break;
        ...
        case _ITER_NEXT_RANGE: {
            ...
            if (Py_UNLIKELY(res == NULL)) JUMP_TO_ERROR();
        ...
        case _CHECK_METHOD_VERSION: {
            ...
            if (Py_UNLIKELY(!PyStackRef_IsNull(null[0]))) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
            break;
        ...
        case _CHECK_CALL_BOUND_METHOD_EXACT_ARGS: {
            ...
            if (Py_UNLIKELY(Py_TYPE(PyStackRef_AsPyObjectBorrow(callable[0])) != &PyMethod_Type)) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
            break;
        ...
        case _CHECK_FUNCTION_EXACT_ARGS: {
            ...
            if (Py_UNLIKELY(code->co_argcount != oparg + (!PyStackRef_IsNull(self_or_null[0])))) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
            break;
        ...
        case _CALL_BUILTIN_O: {
            ...
            if (Py_UNLIKELY(tstate->c_recursion_remaining <= 0)) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
            STAT_INC(CALL, hit);
        ...
        case _CALL_LIST_APPEND: {
            ...
            assert(self_o != NULL);
            if (Py_UNLIKELY(!PyList_Check(self_o))) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
        ...
        case _MAKE_FUNCTION: {
            ...
            if (Py_UNLIKELY(func_obj == NULL)) JUMP_TO_ERROR();
        ...
        case _RETURN_GENERATOR: {
            ...
            stack_pointer = _PyFrame_GetStackPointer(frame);
            if (Py_UNLIKELY(gen == NULL)) JUMP_TO_ERROR();
            assert(EMPTY());
            _PyFrame_SetStackPointer(frame, stack_pointer);
        ...
        case _BUILD_SLICE: {
            ...
            if (Py_UNLIKELY(slice_o == NULL)) JUMP_TO_ERROR();
        ...
        case _CONVERT_VALUE: {
            ...
            stack_pointer = _PyFrame_GetStackPointer(frame);
            PyStackRef_CLOSE(value);
            if (Py_UNLIKELY(result_o == NULL)) JUMP_TO_ERROR();
