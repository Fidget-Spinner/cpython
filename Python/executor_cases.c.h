...
#define TIER_TWO 2
        ...
        /* _BINARY_SUBSCR_GETITEM__REG_OUT_0_REG is not a viable micro-op for tier 2 */

        /* _BINARY_SUBSCR_GETITEM__REG_OUT_1_REG is not a viable micro-op for tier 2 */

        /* _BINARY_SUBSCR_GETITEM__REG_SPILL is not a viable micro-op for tier 2 */
        ...
        /* _INSTRUMENTED_RETURN_VALUE__REG_SPILL is not a viable micro-op for tier 2 */
        ...
        /* _SEND__REG_OUT_0_1_REG is not a viable micro-op for tier 2 */

        /* _SEND__REG_SPILL is not a viable micro-op for tier 2 */

        /* _SEND_GEN__REG_OUT_0_1_REG is not a viable micro-op for tier 2 */

        /* _SEND_GEN__REG_SPILL is not a viable micro-op for tier 2 */

        /* _INSTRUMENTED_YIELD_VALUE__REG_OUT_0_REG is not a viable micro-op for tier 2 */

        /* _INSTRUMENTED_YIELD_VALUE__REG_OUT_1_REG is not a viable micro-op for tier 2 */

        /* _INSTRUMENTED_YIELD_VALUE__REG_SPILL is not a viable micro-op for tier 2 */
        ...
        /* _INSTRUMENTED_LOAD_SUPER_ATTR__REG_SPILL is not a viable micro-op for tier 2 */
        ...
        /* _LOAD_ATTR_GETATTRIBUTE_OVERRIDDEN__REG_SPILL is not a viable micro-op for tier 2 */
        ...
        /* _STORE_ATTR_WITH_HINT__REG_SPILL is not a viable micro-op for tier 2 */
        ...
        /* _POP_JUMP_IF_FALSE__REG_SPILL is not a viable micro-op for tier 2 */

        /* _POP_JUMP_IF_TRUE__REG_SPILL is not a viable micro-op for tier 2 */
        ...
        /* _FOR_ITER__REG_OUT_0_1_REG is not a viable micro-op for tier 2 */

        /* _FOR_ITER__REG_SPILL is not a viable micro-op for tier 2 */
        ...
        /* _ITER_JUMP_LIST__REG_OUT_0_REG is not a viable micro-op for tier 2 */

        /* _ITER_JUMP_LIST__REG_OUT_1_REG is not a viable micro-op for tier 2 */

        /* _ITER_JUMP_LIST__REG_SPILL is not a viable micro-op for tier 2 */
        ...
        /* _ITER_JUMP_TUPLE__REG_OUT_0_REG is not a viable micro-op for tier 2 */

        /* _ITER_JUMP_TUPLE__REG_OUT_1_REG is not a viable micro-op for tier 2 */

        /* _ITER_JUMP_TUPLE__REG_SPILL is not a viable micro-op for tier 2 */
        ...
        /* _ITER_JUMP_RANGE__REG_OUT_0_REG is not a viable micro-op for tier 2 */

        /* _ITER_JUMP_RANGE__REG_OUT_1_REG is not a viable micro-op for tier 2 */

        /* _ITER_JUMP_RANGE__REG_SPILL is not a viable micro-op for tier 2 */
        ...
        /* _FOR_ITER_GEN__REG_OUT_0_1_REG is not a viable micro-op for tier 2 */

        /* _FOR_ITER_GEN__REG_SPILL is not a viable micro-op for tier 2 */
        ...
        /* _CALL__REG_OUT_0_REG is not a viable micro-op for tier 2 */

        /* _CALL__REG_OUT_1_REG is not a viable micro-op for tier 2 */

        /* _CALL__REG_SPILL is not a viable micro-op for tier 2 */
        ...
        case _PUSH_FRAME__REG_SPILL: {
            _PyInterpreterFrame *new_frame;
            new_frame = (_PyInterpreterFrame *)REG_0;
            // Write it out explicitly because it's subtly different.
            // Eventually this should be the only occurrence of this code.
            assert(tstate->interp->eval_frame == NULL);
            stack_pointer += -1;
        ...
        /* _CALL_PY_WITH_DEFAULTS__REG_OUT_0_REG is not a viable micro-op for tier 2 */

        /* _CALL_PY_WITH_DEFAULTS__REG_OUT_1_REG is not a viable micro-op for tier 2 */

        /* _CALL_PY_WITH_DEFAULTS__REG_SPILL is not a viable micro-op for tier 2 */
        ...
        /* _CALL_ALLOC_AND_ENTER_INIT__REG_OUT_0_REG is not a viable micro-op for tier 2 */

        /* _CALL_ALLOC_AND_ENTER_INIT__REG_OUT_1_REG is not a viable micro-op for tier 2 */

        /* _CALL_ALLOC_AND_ENTER_INIT__REG_SPILL is not a viable micro-op for tier 2 */

        case _EXIT_INIT_CHECK__REG_SPILL: {
            PyObject *should_be_none;
            should_be_none = REG_0;
            assert(STACK_LEVEL() == 2);
            if (should_be_none != Py_None) {
                PyErr_Format(PyExc_TypeError,
                             "__init__() should return None, not '%.200s'",
        ...
        /* _CALL_KW__REG_OUT_0_REG is not a viable micro-op for tier 2 */

        /* _CALL_KW__REG_OUT_1_REG is not a viable micro-op for tier 2 */

        /* _CALL_KW__REG_SPILL is not a viable micro-op for tier 2 */

        /* _CALL_FUNCTION_EX__REG_OUT_0_REG is not a viable micro-op for tier 2 */

        /* _CALL_FUNCTION_EX__REG_OUT_1_REG is not a viable micro-op for tier 2 */

        /* _CALL_FUNCTION_EX__REG_SPILL is not a viable micro-op for tier 2 */
