...
#define TIER_TWO 2
        ...
        case _BINARY_OP_MULTIPLY_INT: {
            _JITOutlinedReturnVal retval = _BINARY_OP_MULTIPLY_INT_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        }

        case _BINARY_OP_ADD_INT: {
            _JITOutlinedReturnVal retval = _BINARY_OP_ADD_INT_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _BINARY_OP_SUBTRACT_INT: {
            _JITOutlinedReturnVal retval = _BINARY_OP_SUBTRACT_INT_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _BINARY_OP_MULTIPLY_FLOAT: {
            _JITOutlinedReturnVal retval = _BINARY_OP_MULTIPLY_FLOAT_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _BINARY_OP_ADD_FLOAT: {
            _JITOutlinedReturnVal retval = _BINARY_OP_ADD_FLOAT_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _BINARY_OP_SUBTRACT_FLOAT: {
            _JITOutlinedReturnVal retval = _BINARY_OP_SUBTRACT_FLOAT_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _BINARY_OP_ADD_UNICODE: {
            _JITOutlinedReturnVal retval = _BINARY_OP_ADD_UNICODE_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _BINARY_OP_EXTEND: {
            _JITOutlinedReturnVal retval = _BINARY_OP_EXTEND_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _BINARY_SLICE: {
            _JITOutlinedReturnVal retval = _BINARY_SLICE_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _BINARY_OP_SUBSCR_LIST_SLICE: {
            _JITOutlinedReturnVal retval = _BINARY_OP_SUBSCR_LIST_SLICE_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _BINARY_OP_SUBSCR_DICT: {
            _JITOutlinedReturnVal retval = _BINARY_OP_SUBSCR_DICT_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _STORE_SUBSCR_DICT: {
            _JITOutlinedReturnVal retval = _STORE_SUBSCR_DICT_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _CALL_INTRINSIC_2: {
            _JITOutlinedReturnVal retval = _CALL_INTRINSIC_2_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _RETURN_VALUE: {
            _JITOutlinedReturnVal retval = _RETURN_VALUE_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _GET_AITER: {
            _JITOutlinedReturnVal retval = _GET_AITER_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _YIELD_VALUE: {
            _JITOutlinedReturnVal retval = _YIELD_VALUE_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _STORE_NAME: {
            _JITOutlinedReturnVal retval = _STORE_NAME_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _DELETE_NAME: {
            _JITOutlinedReturnVal retval = _DELETE_NAME_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _MAKE_CELL: {
            _JITOutlinedReturnVal retval = _MAKE_CELL_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _LOAD_FROM_DICT_OR_DEREF: {
            _JITOutlinedReturnVal retval = _LOAD_FROM_DICT_OR_DEREF_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _COPY_FREE_VARS: {
            _JITOutlinedReturnVal retval = _COPY_FREE_VARS_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _BUILD_STRING: {
            _JITOutlinedReturnVal retval = _BUILD_STRING_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _BUILD_INTERPOLATION: {
            _JITOutlinedReturnVal retval = _BUILD_INTERPOLATION_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _BUILD_TEMPLATE: {
            _JITOutlinedReturnVal retval = _BUILD_TEMPLATE_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _LIST_EXTEND: {
            _JITOutlinedReturnVal retval = _LIST_EXTEND_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _BUILD_SET: {
            _JITOutlinedReturnVal retval = _BUILD_SET_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _BUILD_MAP: {
            _JITOutlinedReturnVal retval = _BUILD_MAP_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _DICT_MERGE: {
            _JITOutlinedReturnVal retval = _DICT_MERGE_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _STORE_ATTR_INSTANCE_VALUE: {
            _JITOutlinedReturnVal retval = _STORE_ATTR_INSTANCE_VALUE_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _COMPARE_OP: {
            _JITOutlinedReturnVal retval = _COMPARE_OP_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _COMPARE_OP_FLOAT: {
            _JITOutlinedReturnVal retval = _COMPARE_OP_FLOAT_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _COMPARE_OP_STR: {
            _JITOutlinedReturnVal retval = _COMPARE_OP_STR_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _CONTAINS_OP: {
            _JITOutlinedReturnVal retval = _CONTAINS_OP_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _CONTAINS_OP_SET: {
            _JITOutlinedReturnVal retval = _CONTAINS_OP_SET_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _CONTAINS_OP_DICT: {
            _JITOutlinedReturnVal retval = _CONTAINS_OP_DICT_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _CHECK_EG_MATCH: {
            _JITOutlinedReturnVal retval = _CHECK_EG_MATCH_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _CHECK_EXC_MATCH: {
            _JITOutlinedReturnVal retval = _CHECK_EXC_MATCH_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _ITER_NEXT_TUPLE: {
            _JITOutlinedReturnVal retval = _ITER_NEXT_TUPLE_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _ITER_NEXT_RANGE: {
            _JITOutlinedReturnVal retval = _ITER_NEXT_RANGE_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _WITH_EXCEPT_START: {
            _JITOutlinedReturnVal retval = _WITH_EXCEPT_START_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _PUSH_EXC_INFO: {
            _JITOutlinedReturnVal retval = _PUSH_EXC_INFO_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _LOAD_ATTR_METHOD_WITH_VALUES: {
            _JITOutlinedReturnVal retval = _LOAD_ATTR_METHOD_WITH_VALUES_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _LOAD_ATTR_METHOD_NO_DICT: {
            _JITOutlinedReturnVal retval = _LOAD_ATTR_METHOD_NO_DICT_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _LOAD_ATTR_NONDESCRIPTOR_NO_DICT: {
            _JITOutlinedReturnVal retval = _LOAD_ATTR_NONDESCRIPTOR_NO_DICT_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _LOAD_ATTR_METHOD_LAZY_DICT: {
            _JITOutlinedReturnVal retval = _LOAD_ATTR_METHOD_LAZY_DICT_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _PY_FRAME_GENERAL: {
            _JITOutlinedReturnVal retval = _PY_FRAME_GENERAL_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _EXPAND_METHOD: {
            _JITOutlinedReturnVal retval = _EXPAND_METHOD_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _CALL_NON_PY_GENERAL: {
            _JITOutlinedReturnVal retval = _CALL_NON_PY_GENERAL_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _INIT_CALL_BOUND_METHOD_EXACT_ARGS: {
            _JITOutlinedReturnVal retval = _INIT_CALL_BOUND_METHOD_EXACT_ARGS_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _INIT_CALL_PY_EXACT_ARGS_0: {
            _JITOutlinedReturnVal retval = _INIT_CALL_PY_EXACT_ARGS_0_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _INIT_CALL_PY_EXACT_ARGS_1: {
            _JITOutlinedReturnVal retval = _INIT_CALL_PY_EXACT_ARGS_1_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _INIT_CALL_PY_EXACT_ARGS_2: {
            _JITOutlinedReturnVal retval = _INIT_CALL_PY_EXACT_ARGS_2_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _INIT_CALL_PY_EXACT_ARGS_3: {
            _JITOutlinedReturnVal retval = _INIT_CALL_PY_EXACT_ARGS_3_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _INIT_CALL_PY_EXACT_ARGS_4: {
            _JITOutlinedReturnVal retval = _INIT_CALL_PY_EXACT_ARGS_4_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _INIT_CALL_PY_EXACT_ARGS: {
            _JITOutlinedReturnVal retval = _INIT_CALL_PY_EXACT_ARGS_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _PUSH_FRAME: {
            _JITOutlinedReturnVal retval = _PUSH_FRAME_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _CALL_TYPE_1: {
            _JITOutlinedReturnVal retval = _CALL_TYPE_1_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _CALL_STR_1: {
            _JITOutlinedReturnVal retval = _CALL_STR_1_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _CALL_TUPLE_1: {
            _JITOutlinedReturnVal retval = _CALL_TUPLE_1_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _CREATE_INIT_FRAME: {
            _JITOutlinedReturnVal retval = _CREATE_INIT_FRAME_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _CALL_LEN: {
            _JITOutlinedReturnVal retval = _CALL_LEN_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _PY_FRAME_KW: {
            _JITOutlinedReturnVal retval = _PY_FRAME_KW_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _EXPAND_METHOD_KW: {
            _JITOutlinedReturnVal retval = _EXPAND_METHOD_KW_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _CALL_KW_NON_PY: {
            _JITOutlinedReturnVal retval = _CALL_KW_NON_PY_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _MAKE_FUNCTION: {
            _JITOutlinedReturnVal retval = _MAKE_FUNCTION_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _SET_FUNCTION_ATTRIBUTE: {
            _JITOutlinedReturnVal retval = _SET_FUNCTION_ATTRIBUTE_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            break;
        ...
        case _RETURN_GENERATOR: {
            _JITOutlinedReturnVal retval = _RETURN_GENERATOR_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _BUILD_SLICE: {
            _JITOutlinedReturnVal retval = _BUILD_SLICE_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _CONVERT_VALUE: {
            _JITOutlinedReturnVal retval = _CONVERT_VALUE_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
        ...
        case _BINARY_OP: {
            _JITOutlinedReturnVal retval = _BINARY_OP_outlined(JIT_ARGS, _oparg, _operand0, _operand1, current_executor);
            stack_pointer = retval.stack_pointer;
            tstate = retval.tstate;
            frame = retval.frame;
            if (retval.is_err) { JUMP_TO_ERROR(); }break;
