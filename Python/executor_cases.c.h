...
#define TIER_TWO 2
        ...
        /* _BINARY_SUBSCR_GETITEM__REG is not a viable micro-op for tier 2 */
        ...
        /* _INSTRUMENTED_RETURN_VALUE__REG is not a viable micro-op for tier 2 */
        ...
        /* _SEND__REG is not a viable micro-op for tier 2 */

        /* _SEND__REG_SPILL is not a viable micro-op for tier 2 */

        /* _SEND_GEN__REG is not a viable micro-op for tier 2 */

        /* _SEND_GEN__REG_SPILL is not a viable micro-op for tier 2 */

        /* _INSTRUMENTED_YIELD_VALUE__REG is not a viable micro-op for tier 2 */
        ...
        /* _INSTRUMENTED_LOAD_SUPER_ATTR__REG is not a viable micro-op for tier 2 */
        ...
        /* _LOAD_ATTR_INSTANCE_VALUE__REG is split on (oparg & 1) */
        ...
        /* _LOAD_ATTR_SLOT__REG is split on (oparg & 1) */
        ...
        /* _LOAD_ATTR_CLASS__REG is split on (oparg & 1) */

        /* _LOAD_ATTR_CLASS__REG_SPILL is split on (oparg & 1) */

        /* _LOAD_ATTR_PROPERTY__REG is not a viable micro-op for tier 2 */

        /* _LOAD_ATTR_PROPERTY__REG_SPILL is not a viable micro-op for tier 2 */

        /* _LOAD_ATTR_GETATTRIBUTE_OVERRIDDEN__REG is not a viable micro-op for tier 2 */
        ...
        /* _STORE_ATTR_WITH_HINT__REG is not a viable micro-op for tier 2 */
        ...
        /* _POP_JUMP_IF_FALSE__REG is not a viable micro-op for tier 2 */

        /* _POP_JUMP_IF_FALSE__REG_SPILL is not a viable micro-op for tier 2 */

        /* _POP_JUMP_IF_TRUE__REG is not a viable micro-op for tier 2 */
        ...
        /* _FOR_ITER__REG is not a viable micro-op for tier 2 */
        ...
        /* _ITER_JUMP_LIST__REG is not a viable micro-op for tier 2 */
        ...
        /* _ITER_JUMP_TUPLE__REG is not a viable micro-op for tier 2 */
        ...
        /* _ITER_JUMP_RANGE__REG is not a viable micro-op for tier 2 */
        ...
        /* _FOR_ITER_GEN__REG is not a viable micro-op for tier 2 */
        ...
        /* _CALL__REG is not a viable micro-op for tier 2 */
        ...
        /* _CALL_PY_WITH_DEFAULTS__REG is not a viable micro-op for tier 2 */
        ...
        /* _CALL_ALLOC_AND_ENTER_INIT__REG is not a viable micro-op for tier 2 */
        ...
        /* _CALL_KW__REG is not a viable micro-op for tier 2 */

        /* _CALL_KW__REG_SPILL is not a viable micro-op for tier 2 */

        /* _CALL_FUNCTION_EX__REG is not a viable micro-op for tier 2 */
