...
#define TIER_TWO 2
        ...
        case BINARY_OP_INPLACE_ADD_UNICODE: {
            ...
            // _BINARY_OP_INPLACE_ADD_UNICODE
            {
                ...
                *target_local = PyStackRef_FromPyObjectSteal(temp);
                ...
                if (PyStackRef_IsNull(*target_local)) JUMP_TO_ERROR(1);
                #if TIER_ONE
        ...
        case EXTENDED_ARG: {
            ...
            fprintf(stderr, "Executing EXTENDED_ARG\n");
            Py_UNREACHABLE();
            break;
        }
        ...
        case FOR_ITER_LIST: {
            /* Not viable for tier 2 (manual) */
            fprintf(stderr, "Executing FOR_ITER_LIST\n");
            Py_UNREACHABLE();
            break;
        }
        ...
        case FOR_ITER_RANGE: {
            /* Not viable for tier 2 (manual) */
            fprintf(stderr, "Executing FOR_ITER_RANGE\n");
            Py_UNREACHABLE();
            break;
        }
        ...
        case FOR_ITER_TUPLE: {
            /* Not viable for tier 2 (manual) */
            fprintf(stderr, "Executing FOR_ITER_TUPLE\n");
            Py_UNREACHABLE();
            break;
        }
        ...
        case INSTRUMENTED_CALL_FUNCTION_EX: {
            /* Not viable for tier 2 (manual) */
            fprintf(stderr, "Executing INSTRUMENTED_CALL_FUNCTION_EX\n");
            Py_UNREACHABLE();
            break;
        }
        ...
        case INSTRUMENTED_LINE: {
            /* Not viable for tier 2 (needs prev_instr) */
            fprintf(stderr, "Executing INSTRUMENTED_LINE\n");
            Py_UNREACHABLE();
            break;
        }
        ...
        case INTERPRETER_EXIT: {
            /* Not viable for tier 2 (manual) */
            fprintf(stderr, "Executing INTERPRETER_EXIT\n");
            Py_UNREACHABLE();
            break;
        }
        ...
        case LOAD_ATTR_GETATTRIBUTE_OVERRIDDEN: {
            /* Not viable for tier 2 (more than 2 cache entries) */
            fprintf(stderr, "Executing LOAD_ATTR_GETATTRIBUTE_OVERRIDDEN\n");
            Py_UNREACHABLE();
            break;
        }
        ...
        case LOAD_ATTR_WITH_HINT: {
            ...
            {
                oparg = CURRENT_OPARG(2);
                uint16_t hint = (uint16_t)CURRENT_OPERAND0(2);
                PyObject *owner_o = PyStackRef_AsPyObjectBorrow(owner);
                PyObject *attr_o;
                PyDictObject *dict = _PyObject_GetManagedDict(owner_o);
        ...
        case LOAD_GLOBAL_BUILTIN: {
            ...
            {
                uint16_t version = (uint16_t)CURRENT_OPERAND0(1);
            ...
            {
                oparg = CURRENT_OPARG(2);
                uint16_t index = (uint16_t)CURRENT_OPERAND0(2);
