...
// BEGIN BYTECODES //
    ...
    op(_CREATE_INIT_FRAME, (init, self, args[oparg] -- init_frame)) {
        ...
        curr_space += _Py_InitCleanup.co_framesize;
        ...
        // No choice but to manually adjust it ourselves.
        // Note there's an extra 1 because this is *after* the _PUSH_FRAME.
        old_frame->stack_pointer -= (oparg + 1 + 1);
    }
