...
{
    assert(PyCode_Check(PyStackRef_AsPyObjectBorrow(pyframe->f_executable)));
    ...
    PyObject *filename = filename = ((PyCodeObject *)PyStackRef_AsPyObjectBorrow(pyframe->f_executable))->co_filename;
