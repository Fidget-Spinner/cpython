...
#define _BINARY_OP_ADD_TAGGED_DOUBLE 305
...
#define _BINARY_OP_MULTIPLY_INT 310
#define _BINARY_OP_MULTIPLY_TAGGED_DOUBLE 311
...
#define _BINARY_OP_SUBTRACT_INT 320
#define _BINARY_OP_SUBTRACT_TAGGED_DOUBLE 321
...
#define _NOP NOP
#define _NOS_TO_TAGGED_DOUBLE 502
...
#define _SWAP_2 549
#define _SWAP_3 550
#define _THIRD_TO_FLOAT 551
#define _THIRD_TO_TAGGED_DOUBLE 552
#define _TIER2_RESUME_CHECK 553
#define _TOS_TO_TAGGED_DOUBLE 554
#define _TO_BOOL 555
...
#define _BINARY_OP_ADD_TAGGED_DOUBLE_r03 569
#define _BINARY_OP_ADD_TAGGED_DOUBLE_r13 570
#define _BINARY_OP_ADD_TAGGED_DOUBLE_r23 571
...
#define _BINARY_OP_MULTIPLY_TAGGED_DOUBLE_r03 583
#define _BINARY_OP_MULTIPLY_TAGGED_DOUBLE_r13 584
#define _BINARY_OP_MULTIPLY_TAGGED_DOUBLE_r23 585
#define _BINARY_OP_SUBSCR_CHECK_FUNC_r23 586
#define _BINARY_OP_SUBSCR_DICT_r21 587
#define _BINARY_OP_SUBSCR_INIT_CALL_r01 588
#define _BINARY_OP_SUBSCR_INIT_CALL_r11 589
#define _BINARY_OP_SUBSCR_INIT_CALL_r21 590
#define _BINARY_OP_SUBSCR_INIT_CALL_r31 591
#define _BINARY_OP_SUBSCR_LIST_INT_r23 592
#define _BINARY_OP_SUBSCR_LIST_SLICE_r21 593
#define _BINARY_OP_SUBSCR_STR_INT_r23 594
#define _BINARY_OP_SUBSCR_TUPLE_INT_r21 595
...
#define _BINARY_OP_SUBTRACT_TAGGED_DOUBLE_r03 602
#define _BINARY_OP_SUBTRACT_TAGGED_DOUBLE_r13 603
#define _BINARY_OP_SUBTRACT_TAGGED_DOUBLE_r23 604
#define _BINARY_SLICE_r31 605
#define _BUILD_INTERPOLATION_r01 606
#define _BUILD_LIST_r01 607
#define _BUILD_MAP_r01 608
#define _BUILD_SET_r01 609
#define _BUILD_SLICE_r01 610
#define _BUILD_STRING_r01 611
#define _BUILD_TEMPLATE_r21 612
#define _BUILD_TUPLE_r01 613
#define _CALL_BUILTIN_CLASS_r01 614
#define _CALL_BUILTIN_FAST_r01 615
#define _CALL_BUILTIN_FAST_WITH_KEYWORDS_r01 616
#define _CALL_BUILTIN_O_r03 617
...
#define _CALL_LIST_APPEND_r02 623
#define _CALL_LIST_APPEND_r12 624
#define _CALL_LIST_APPEND_r22 625
#define _CALL_LIST_APPEND_r32 626
...
#define _CHECK_IS_NOT_PY_CALLABLE_KW_r11 655
#define _CHECK_MANAGED_OBJECT_HAS_VALUES_r01 656
#define _CHECK_MANAGED_OBJECT_HAS_VALUES_r11 657
#define _CHECK_MANAGED_OBJECT_HAS_VALUES_r22 658
#define _CHECK_MANAGED_OBJECT_HAS_VALUES_r33 659
#define _CHECK_METHOD_VERSION_r00 660
#define _CHECK_METHOD_VERSION_KW_r11 661
#define _CHECK_PEP_523_r00 662
#define _CHECK_PEP_523_r11 663
#define _CHECK_PEP_523_r22 664
#define _CHECK_PEP_523_r33 665
#define _CHECK_PERIODIC_r00 666
#define _CHECK_PERIODIC_AT_END_r00 667
#define _CHECK_PERIODIC_IF_NOT_YIELD_FROM_r00 668
...
#define _COMPARE_OP_FLOAT_r01 685
#define _COMPARE_OP_FLOAT_r11 686
#define _COMPARE_OP_FLOAT_r21 687
#define _COMPARE_OP_FLOAT_r32 688
#define _COMPARE_OP_INT_r23 689
#define _COMPARE_OP_STR_r21 690
...
#define _LOAD_ATTR_INSTANCE_VALUE_r02 1002
#define _LOAD_ATTR_INSTANCE_VALUE_r12 1003
#define _LOAD_ATTR_INSTANCE_VALUE_r23 1004
#define _LOAD_ATTR_METHOD_LAZY_DICT_r02 1005
#define _LOAD_ATTR_METHOD_LAZY_DICT_r12 1006
#define _LOAD_ATTR_METHOD_LAZY_DICT_r23 1007
#define _LOAD_ATTR_METHOD_NO_DICT_r02 1008
#define _LOAD_ATTR_METHOD_NO_DICT_r12 1009
#define _LOAD_ATTR_METHOD_NO_DICT_r23 1010
#define _LOAD_ATTR_METHOD_WITH_VALUES_r02 1011
#define _LOAD_ATTR_METHOD_WITH_VALUES_r12 1012
#define _LOAD_ATTR_METHOD_WITH_VALUES_r23 1013
#define _LOAD_ATTR_MODULE_r11 1014
#define _LOAD_ATTR_NONDESCRIPTOR_NO_DICT_r11 1015
#define _LOAD_ATTR_NONDESCRIPTOR_WITH_VALUES_r11 1016
#define _LOAD_ATTR_PROPERTY_FRAME_r11 1017
#define _LOAD_ATTR_SLOT_r11 1018
#define _LOAD_ATTR_WITH_HINT_r11 1019
#define _LOAD_BUILD_CLASS_r01 1020
#define _LOAD_BYTECODE_r00 1021
#define _LOAD_COMMON_CONSTANT_r01 1022
#define _LOAD_COMMON_CONSTANT_r12 1023
#define _LOAD_COMMON_CONSTANT_r23 1024
#define _LOAD_CONST_r01 1025
#define _LOAD_CONST_r12 1026
#define _LOAD_CONST_r23 1027
#define _LOAD_CONST_INLINE_r01 1028
#define _LOAD_CONST_INLINE_r12 1029
#define _LOAD_CONST_INLINE_r23 1030
#define _LOAD_CONST_INLINE_BORROW_r01 1031
#define _LOAD_CONST_INLINE_BORROW_r12 1032
#define _LOAD_CONST_INLINE_BORROW_r23 1033
#define _LOAD_CONST_UNDER_INLINE_r02 1034
#define _LOAD_CONST_UNDER_INLINE_r12 1035
#define _LOAD_CONST_UNDER_INLINE_r23 1036
#define _LOAD_CONST_UNDER_INLINE_BORROW_r02 1037
#define _LOAD_CONST_UNDER_INLINE_BORROW_r12 1038
#define _LOAD_CONST_UNDER_INLINE_BORROW_r23 1039
#define _LOAD_DEREF_r01 1040
#define _LOAD_FAST_r01 1041
#define _LOAD_FAST_r12 1042
#define _LOAD_FAST_r23 1043
#define _LOAD_FAST_0_r01 1044
#define _LOAD_FAST_0_r12 1045
#define _LOAD_FAST_0_r23 1046
#define _LOAD_FAST_1_r01 1047
#define _LOAD_FAST_1_r12 1048
#define _LOAD_FAST_1_r23 1049
#define _LOAD_FAST_2_r01 1050
#define _LOAD_FAST_2_r12 1051
#define _LOAD_FAST_2_r23 1052
#define _LOAD_FAST_3_r01 1053
#define _LOAD_FAST_3_r12 1054
#define _LOAD_FAST_3_r23 1055
#define _LOAD_FAST_4_r01 1056
#define _LOAD_FAST_4_r12 1057
#define _LOAD_FAST_4_r23 1058
#define _LOAD_FAST_5_r01 1059
#define _LOAD_FAST_5_r12 1060
#define _LOAD_FAST_5_r23 1061
#define _LOAD_FAST_6_r01 1062
#define _LOAD_FAST_6_r12 1063
#define _LOAD_FAST_6_r23 1064
#define _LOAD_FAST_7_r01 1065
#define _LOAD_FAST_7_r12 1066
#define _LOAD_FAST_7_r23 1067
#define _LOAD_FAST_AND_CLEAR_r01 1068
#define _LOAD_FAST_AND_CLEAR_r12 1069
#define _LOAD_FAST_AND_CLEAR_r23 1070
#define _LOAD_FAST_BORROW_r01 1071
#define _LOAD_FAST_BORROW_r12 1072
#define _LOAD_FAST_BORROW_r23 1073
#define _LOAD_FAST_BORROW_0_r01 1074
#define _LOAD_FAST_BORROW_0_r12 1075
#define _LOAD_FAST_BORROW_0_r23 1076
#define _LOAD_FAST_BORROW_1_r01 1077
#define _LOAD_FAST_BORROW_1_r12 1078
#define _LOAD_FAST_BORROW_1_r23 1079
#define _LOAD_FAST_BORROW_2_r01 1080
#define _LOAD_FAST_BORROW_2_r12 1081
#define _LOAD_FAST_BORROW_2_r23 1082
#define _LOAD_FAST_BORROW_3_r01 1083
#define _LOAD_FAST_BORROW_3_r12 1084
#define _LOAD_FAST_BORROW_3_r23 1085
#define _LOAD_FAST_BORROW_4_r01 1086
#define _LOAD_FAST_BORROW_4_r12 1087
#define _LOAD_FAST_BORROW_4_r23 1088
#define _LOAD_FAST_BORROW_5_r01 1089
#define _LOAD_FAST_BORROW_5_r12 1090
#define _LOAD_FAST_BORROW_5_r23 1091
#define _LOAD_FAST_BORROW_6_r01 1092
#define _LOAD_FAST_BORROW_6_r12 1093
#define _LOAD_FAST_BORROW_6_r23 1094
#define _LOAD_FAST_BORROW_7_r01 1095
#define _LOAD_FAST_BORROW_7_r12 1096
#define _LOAD_FAST_BORROW_7_r23 1097
#define _LOAD_FAST_BORROW_LOAD_FAST_BORROW_r02 1098
#define _LOAD_FAST_BORROW_LOAD_FAST_BORROW_r13 1099
#define _LOAD_FAST_CHECK_r01 1100
#define _LOAD_FAST_CHECK_r12 1101
#define _LOAD_FAST_CHECK_r23 1102
#define _LOAD_FAST_LOAD_FAST_r02 1103
#define _LOAD_FAST_LOAD_FAST_r13 1104
#define _LOAD_FROM_DICT_OR_DEREF_r11 1105
#define _LOAD_FROM_DICT_OR_GLOBALS_r11 1106
#define _LOAD_GLOBAL_r00 1107
#define _LOAD_GLOBAL_BUILTINS_r01 1108
#define _LOAD_GLOBAL_MODULE_r01 1109
#define _LOAD_LOCALS_r01 1110
#define _LOAD_LOCALS_r12 1111
#define _LOAD_LOCALS_r23 1112
#define _LOAD_NAME_r01 1113
#define _LOAD_SMALL_INT_r01 1114
#define _LOAD_SMALL_INT_r12 1115
#define _LOAD_SMALL_INT_r23 1116
#define _LOAD_SMALL_INT_0_r01 1117
#define _LOAD_SMALL_INT_0_r12 1118
#define _LOAD_SMALL_INT_0_r23 1119
#define _LOAD_SMALL_INT_1_r01 1120
#define _LOAD_SMALL_INT_1_r12 1121
#define _LOAD_SMALL_INT_1_r23 1122
#define _LOAD_SMALL_INT_2_r01 1123
#define _LOAD_SMALL_INT_2_r12 1124
#define _LOAD_SMALL_INT_2_r23 1125
#define _LOAD_SMALL_INT_3_r01 1126
#define _LOAD_SMALL_INT_3_r12 1127
#define _LOAD_SMALL_INT_3_r23 1128
#define _LOAD_SPECIAL_r00 1129
#define _LOAD_SUPER_ATTR_ATTR_r31 1130
#define _LOAD_SUPER_ATTR_METHOD_r32 1131
#define _MAKE_CALLARGS_A_TUPLE_r33 1132
#define _MAKE_CELL_r00 1133
#define _MAKE_FUNCTION_r11 1134
#define _MAKE_WARM_r00 1135
#define _MAKE_WARM_r11 1136
#define _MAKE_WARM_r22 1137
#define _MAKE_WARM_r33 1138
#define _MAP_ADD_r20 1139
#define _MATCH_CLASS_r31 1140
#define _MATCH_KEYS_r23 1141
#define _MATCH_MAPPING_r02 1142
#define _MATCH_MAPPING_r12 1143
#define _MATCH_MAPPING_r23 1144
#define _MATCH_SEQUENCE_r02 1145
#define _MATCH_SEQUENCE_r12 1146
#define _MATCH_SEQUENCE_r23 1147
#define _MAYBE_EXPAND_METHOD_r00 1148
#define _MAYBE_EXPAND_METHOD_KW_r11 1149
#define _MONITOR_CALL_r00 1150
#define _MONITOR_CALL_KW_r11 1151
#define _MONITOR_JUMP_BACKWARD_r00 1152
#define _MONITOR_JUMP_BACKWARD_r11 1153
#define _MONITOR_JUMP_BACKWARD_r22 1154
#define _MONITOR_JUMP_BACKWARD_r33 1155
#define _MONITOR_RESUME_r00 1156
#define _NOP_r00 1157
#define _NOP_r11 1158
#define _NOP_r22 1159
#define _NOP_r33 1160
#define _NOS_TO_TAGGED_DOUBLE_r02 1161
#define _NOS_TO_TAGGED_DOUBLE_r12 1162
#define _NOS_TO_TAGGED_DOUBLE_r22 1163
#define _NOS_TO_TAGGED_DOUBLE_r33 1164
#define _POP_CALL_r20 1165
#define _POP_CALL_LOAD_CONST_INLINE_BORROW_r21 1166
#define _POP_CALL_ONE_r30 1167
#define _POP_CALL_ONE_LOAD_CONST_INLINE_BORROW_r31 1168
#define _POP_CALL_TWO_r30 1169
#define _POP_CALL_TWO_LOAD_CONST_INLINE_BORROW_r31 1170
#define _POP_EXCEPT_r10 1171
#define _POP_ITER_r20 1172
#define _POP_JUMP_IF_FALSE_r00 1173
#define _POP_JUMP_IF_FALSE_r10 1174
#define _POP_JUMP_IF_FALSE_r21 1175
#define _POP_JUMP_IF_FALSE_r32 1176
#define _POP_JUMP_IF_TRUE_r00 1177
#define _POP_JUMP_IF_TRUE_r10 1178
#define _POP_JUMP_IF_TRUE_r21 1179
#define _POP_JUMP_IF_TRUE_r32 1180
#define _POP_TOP_r10 1181
#define _POP_TOP_FLOAT_r00 1182
#define _POP_TOP_FLOAT_r10 1183
#define _POP_TOP_FLOAT_r21 1184
#define _POP_TOP_FLOAT_r32 1185
#define _POP_TOP_INT_r00 1186
#define _POP_TOP_INT_r10 1187
#define _POP_TOP_INT_r21 1188
#define _POP_TOP_INT_r32 1189
#define _POP_TOP_LOAD_CONST_INLINE_r11 1190
#define _POP_TOP_LOAD_CONST_INLINE_BORROW_r11 1191
#define _POP_TOP_NOP_r00 1192
#define _POP_TOP_NOP_r10 1193
#define _POP_TOP_NOP_r21 1194
#define _POP_TOP_NOP_r32 1195
#define _POP_TOP_UNICODE_r00 1196
#define _POP_TOP_UNICODE_r10 1197
#define _POP_TOP_UNICODE_r21 1198
#define _POP_TOP_UNICODE_r32 1199
#define _POP_TWO_r20 1200
#define _POP_TWO_LOAD_CONST_INLINE_BORROW_r21 1201
#define _PUSH_EXC_INFO_r02 1202
#define _PUSH_EXC_INFO_r12 1203
#define _PUSH_EXC_INFO_r23 1204
#define _PUSH_FRAME_r10 1205
#define _PUSH_NULL_r01 1206
#define _PUSH_NULL_r12 1207
#define _PUSH_NULL_r23 1208
#define _PUSH_NULL_CONDITIONAL_r00 1209
#define _PY_FRAME_GENERAL_r01 1210
#define _PY_FRAME_KW_r11 1211
#define _QUICKEN_RESUME_r00 1212
#define _QUICKEN_RESUME_r11 1213
#define _QUICKEN_RESUME_r22 1214
#define _QUICKEN_RESUME_r33 1215
#define _REPLACE_WITH_TRUE_r11 1216
#define _RESUME_CHECK_r00 1217
#define _RESUME_CHECK_r11 1218
#define _RESUME_CHECK_r22 1219
#define _RESUME_CHECK_r33 1220
#define _RETURN_GENERATOR_r01 1221
#define _RETURN_VALUE_r11 1222
#define _SAVE_RETURN_OFFSET_r00 1223
#define _SAVE_RETURN_OFFSET_r11 1224
#define _SAVE_RETURN_OFFSET_r22 1225
#define _SAVE_RETURN_OFFSET_r33 1226
#define _SEND_r22 1227
#define _SEND_GEN_FRAME_r22 1228
#define _SETUP_ANNOTATIONS_r00 1229
#define _SET_ADD_r10 1230
#define _SET_FUNCTION_ATTRIBUTE_r01 1231
#define _SET_FUNCTION_ATTRIBUTE_r11 1232
#define _SET_FUNCTION_ATTRIBUTE_r21 1233
#define _SET_FUNCTION_ATTRIBUTE_r32 1234
#define _SET_IP_r00 1235
#define _SET_IP_r11 1236
#define _SET_IP_r22 1237
#define _SET_IP_r33 1238
#define _SET_UPDATE_r10 1239
#define _SHUFFLE_3_LOAD_CONST_INLINE_BORROW_r03 1240
#define _SHUFFLE_3_LOAD_CONST_INLINE_BORROW_r13 1241
#define _SHUFFLE_3_LOAD_CONST_INLINE_BORROW_r23 1242
#define _SHUFFLE_3_LOAD_CONST_INLINE_BORROW_r33 1243
#define _SPILL_OR_RELOAD_r01 1244
#define _SPILL_OR_RELOAD_r02 1245
#define _SPILL_OR_RELOAD_r03 1246
#define _SPILL_OR_RELOAD_r10 1247
#define _SPILL_OR_RELOAD_r12 1248
#define _SPILL_OR_RELOAD_r13 1249
#define _SPILL_OR_RELOAD_r20 1250
#define _SPILL_OR_RELOAD_r21 1251
#define _SPILL_OR_RELOAD_r23 1252
#define _SPILL_OR_RELOAD_r30 1253
#define _SPILL_OR_RELOAD_r31 1254
#define _SPILL_OR_RELOAD_r32 1255
#define _START_EXECUTOR_r00 1256
#define _STORE_ATTR_r20 1257
#define _STORE_ATTR_INSTANCE_VALUE_r21 1258
#define _STORE_ATTR_SLOT_r21 1259
#define _STORE_ATTR_WITH_HINT_r21 1260
#define _STORE_DEREF_r10 1261
#define _STORE_FAST_r10 1262
#define _STORE_FAST_0_r10 1263
#define _STORE_FAST_1_r10 1264
#define _STORE_FAST_2_r10 1265
#define _STORE_FAST_3_r10 1266
#define _STORE_FAST_4_r10 1267
#define _STORE_FAST_5_r10 1268
#define _STORE_FAST_6_r10 1269
#define _STORE_FAST_7_r10 1270
#define _STORE_FAST_LOAD_FAST_r11 1271
#define _STORE_FAST_STORE_FAST_r20 1272
#define _STORE_GLOBAL_r10 1273
#define _STORE_NAME_r10 1274
#define _STORE_SLICE_r30 1275
#define _STORE_SUBSCR_r30 1276
#define _STORE_SUBSCR_DICT_r31 1277
#define _STORE_SUBSCR_LIST_INT_r32 1278
#define _SWAP_r11 1279
#define _SWAP_2_r02 1280
#define _SWAP_2_r12 1281
#define _SWAP_2_r22 1282
#define _SWAP_2_r33 1283
#define _SWAP_3_r03 1284
#define _SWAP_3_r13 1285
#define _SWAP_3_r23 1286
#define _SWAP_3_r33 1287
#define _THIRD_TO_FLOAT_r03 1288
#define _THIRD_TO_FLOAT_r13 1289
#define _THIRD_TO_FLOAT_r23 1290
#define _THIRD_TO_FLOAT_r33 1291
#define _THIRD_TO_TAGGED_DOUBLE_r03 1292
#define _THIRD_TO_TAGGED_DOUBLE_r13 1293
#define _THIRD_TO_TAGGED_DOUBLE_r23 1294
#define _THIRD_TO_TAGGED_DOUBLE_r33 1295
#define _TIER2_RESUME_CHECK_r00 1296
#define _TIER2_RESUME_CHECK_r11 1297
#define _TIER2_RESUME_CHECK_r22 1298
#define _TIER2_RESUME_CHECK_r33 1299
#define _TOS_TO_TAGGED_DOUBLE_r01 1300
#define _TOS_TO_TAGGED_DOUBLE_r11 1301
#define _TOS_TO_TAGGED_DOUBLE_r22 1302
#define _TOS_TO_TAGGED_DOUBLE_r33 1303
#define _TO_BOOL_r11 1304
#define _TO_BOOL_BOOL_r01 1305
#define _TO_BOOL_BOOL_r11 1306
#define _TO_BOOL_BOOL_r22 1307
#define _TO_BOOL_BOOL_r33 1308
#define _TO_BOOL_INT_r11 1309
#define _TO_BOOL_LIST_r11 1310
#define _TO_BOOL_NONE_r01 1311
#define _TO_BOOL_NONE_r11 1312
#define _TO_BOOL_NONE_r22 1313
#define _TO_BOOL_NONE_r33 1314
#define _TO_BOOL_STR_r11 1315
#define _TRACE_RECORD_r00 1316
#define _UNARY_INVERT_r11 1317
#define _UNARY_NEGATIVE_r11 1318
#define _UNARY_NOT_r01 1319
#define _UNARY_NOT_r11 1320
#define _UNARY_NOT_r22 1321
#define _UNARY_NOT_r33 1322
#define _UNPACK_EX_r10 1323
#define _UNPACK_SEQUENCE_r10 1324
#define _UNPACK_SEQUENCE_LIST_r10 1325
#define _UNPACK_SEQUENCE_TUPLE_r10 1326
#define _UNPACK_SEQUENCE_TWO_TUPLE_r12 1327
#define _WITH_EXCEPT_START_r33 1328
#define _YIELD_VALUE_r11 1329
#define MAX_UOP_REGS_ID 1329
