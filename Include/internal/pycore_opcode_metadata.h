...
#define OPCODE_HAS_UNBOXED(OP) (_PyOpcode_opcode_metadata[OP].flags & (HAS_UNBOXED_FLAG))
...
const struct opcode_metadata _PyOpcode_opcode_metadata[264] = {
    ...
    [END_FOR] = { true, INSTR_FMT_IX, HAS_STATIC_FLAG },
    ...
    [LOAD_FAST] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_STATIC_FLAG },
    ...
    [NOP] = { true, INSTR_FMT_IX, HAS_STATIC_FLAG },
    ...
    [POP_TOP] = { true, INSTR_FMT_IX, HAS_STATIC_FLAG },
    ...
    [STORE_FAST] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_STATIC_FLAG },
    ...
    [LOAD_CLOSURE] = { true, -1, HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_STATIC_FLAG },
    [POP_BLOCK] = { true, -1, HAS_STATIC_FLAG },
    [SETUP_CLEANUP] = { true, -1, HAS_STATIC_FLAG | HAS_ARG_FLAG },
    [SETUP_FINALLY] = { true, -1, HAS_STATIC_FLAG | HAS_ARG_FLAG },
    [SETUP_WITH] = { true, -1, HAS_STATIC_FLAG | HAS_ARG_FLAG },
    [STORE_FAST_MAYBE_NULL] = { true, -1, HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_STATIC_FLAG },
};
#endif
