...
const struct opcode_metadata _PyOpcode_opcode_metadata[266] = {
    ...
    [INSTRUMENTED_YIELD_VALUE] = { true, INSTR_FMT_IBC, HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG },
    ...
    [RESUME_JIT] = { true, INSTR_FMT_IBC, HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG },
    ...
    [YIELD_VALUE] = { true, INSTR_FMT_IBC, HAS_ARG_FLAG },
    [YIELD_VALUE_JIT] = { true, INSTR_FMT_IBC, HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG },
...
_PyOpcode_macro_expansion[256] = {
    ...
    [FOR_ITER] = { .nuops = 1, .uops = { { _FOR_ITER, OPARG_REPLACED, 1 } } },
    [FOR_ITER_GEN] = { .nuops = 3, .uops = { { _CHECK_PEP_523, OPARG_SIMPLE, 2 }, { _FOR_ITER_GEN_FRAME, OPARG_SIMPLE, 2 }, { _PUSH_FRAME, OPARG_SIMPLE, 2 } } },
    [FOR_ITER_LIST] = { .nuops = 3, .uops = { { _ITER_CHECK_LIST, OPARG_SIMPLE, 2 }, { _ITER_JUMP_LIST, OPARG_REPLACED, 2 }, { _ITER_NEXT_LIST, OPARG_REPLACED, 2 } } },
    [FOR_ITER_RANGE] = { .nuops = 3, .uops = { { _ITER_CHECK_RANGE, OPARG_SIMPLE, 2 }, { _ITER_JUMP_RANGE, OPARG_REPLACED, 2 }, { _ITER_NEXT_RANGE, OPARG_SIMPLE, 2 } } },
    [FOR_ITER_TUPLE] = { .nuops = 3, .uops = { { _ITER_CHECK_TUPLE, OPARG_SIMPLE, 2 }, { _ITER_JUMP_TUPLE, OPARG_REPLACED, 2 }, { _ITER_NEXT_TUPLE, OPARG_SIMPLE, 2 } } },
    ...
    [SEND_GEN] = { .nuops = 3, .uops = { { _CHECK_PEP_523, OPARG_SIMPLE, 2 }, { _SEND_GEN_FRAME, OPARG_SIMPLE, 2 }, { _PUSH_FRAME, OPARG_SIMPLE, 2 } } },
    ...
    [YIELD_VALUE] = { .nuops = 1, .uops = { { _YIELD_VALUE, OPARG_SIMPLE, 1 } } },
};
...
const char *_PyOpcode_OpName[266] = {
    ...
    [YIELD_VALUE_JIT] = "YIELD_VALUE_JIT",
};
#endif
