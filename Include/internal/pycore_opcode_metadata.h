...
#define OPCODE_HAS_SUPER(OP) (_PyOpcode_opcode_metadata[OP].flags & (HAS_SUPER_FLAG))
...
#ifdef NEED_OPCODE_METADATA
const int
_PyOpcode_is_viable_for_tier2[256] = {
    [NOP] = 1,
    [RESUME_CHECK] = 1,
    [LOAD_FAST_CHECK] = 1,
    [LOAD_FAST] = 1,
    ...
    [POP_TOP] = 1,
    [PUSH_NULL] = 1,
    [INSTRUMENTED_END_FOR] = 0,
    [END_SEND] = 1,
    [INSTRUMENTED_END_SEND] = 0,
    [UNARY_NEGATIVE] = 1,
    [UNARY_NOT] = 1,
    [TO_BOOL_BOOL] = 1,
    [TO_BOOL_INT] = 1,
    ...
    [LOAD_ATTR_GETATTRIBUTE_OVERRIDDEN] = 0,
    [IS_OP] = 1,
    [CONTAINS_OP_SET] = 1,
    [CONTAINS_OP_DICT] = 1,
    [CHECK_EG_MATCH] = 1,
