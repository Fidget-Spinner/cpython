...
const struct opcode_metadata _PyOpcode_opcode_metadata[267] = {
    ...
    [LOAD_ATTR] = { true, INSTR_FMT_IBC00000000, HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_RECORDS_VALUE_FLAG },
...
_PyOpcode_macro_expansion[256] = {
    ...
    [LOAD_ATTR] = { .nuops = 2, .uops = { { _RECORD_TOS, OPARG_SIMPLE, 0 }, { _LOAD_ATTR, OPARG_SIMPLE, 8 } } },
