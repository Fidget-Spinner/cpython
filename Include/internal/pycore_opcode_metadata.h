...
int _PyOpcode_num_popped(int opcode, int oparg)  {
    switch(opcode) {
        ...
        case BINARY_OP_ADD_INT:
            return 2;
        case BINARY_OP_ADD_INT_UNBOXED:
            return 2;
        ...
        case BINARY_OP_MULTIPLY_INT:
            return 2;
        case BINARY_OP_MULTIPLY_INT_UNBOXED:
            return 2;
        case BINARY_OP_SUBTRACT_FLOAT:
            return 2;
        case BINARY_OP_SUBTRACT_INT:
            return 2;
        case BINARY_OP_SUBTRACT_INT_UNBOXED:
            return 2;
        case BINARY_SLICE:
            return 3;
        case BINARY_SUBSCR:
...
const struct opcode_metadata _PyOpcode_opcode_metadata[264] = {
    ...
    [BINARY_OP_ADD_INT_UNBOXED] = { true, INSTR_FMT_IXC, HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG },
    ...
    [BINARY_OP_MULTIPLY_INT_UNBOXED] = { true, INSTR_FMT_IXC, HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG },
    ...
    [BINARY_OP_SUBTRACT_INT_UNBOXED] = { true, INSTR_FMT_IXC, HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG },
    ...
    [COMPARE_OP_INT_UNBOXED] = { true, INSTR_FMT_IBC, HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG },
...
_PyOpcode_macro_expansion[256] = {
    ...
    [BINARY_OP_ADD_INT_UNBOXED] = { .nuops = 2, .uops = { { _GUARD_BOTH_INT_UNBOXED, 0, 0 }, { _BINARY_OP_ADD_INT_UNBOXED, 0, 0 } } },
    ...
    [BINARY_OP_MULTIPLY_INT_UNBOXED] = { .nuops = 2, .uops = { { _GUARD_BOTH_INT_UNBOXED, 0, 0 }, { _BINARY_OP_MULTIPLY_INT_UNBOXED, 0, 0 } } },
    ...
    [BINARY_OP_SUBTRACT_INT_UNBOXED] = { .nuops = 2, .uops = { { _GUARD_BOTH_INT_UNBOXED, 0, 0 }, { _BINARY_OP_SUBTRACT_INT_UNBOXED, 0, 0 } } },
    ...
    [COMPARE_OP_INT_UNBOXED] = { .nuops = 2, .uops = { { _GUARD_BOTH_INT_UNBOXED, 0, 0 }, { _COMPARE_OP_INT_UNBOXED, 0, 0 } } },
...
const char *_PyOpcode_OpName[264] = {
    ...
    [BINARY_OP_ADD_INT_UNBOXED] = "BINARY_OP_ADD_INT_UNBOXED",
    [BINARY_OP_ADD_UNICODE] = "BINARY_OP_ADD_UNICODE",
    [BINARY_OP_INPLACE_ADD_UNICODE] = "BINARY_OP_INPLACE_ADD_UNICODE",
    [BINARY_OP_MULTIPLY_FLOAT] = "BINARY_OP_MULTIPLY_FLOAT",
    [BINARY_OP_MULTIPLY_INT] = "BINARY_OP_MULTIPLY_INT",
    [BINARY_OP_MULTIPLY_INT_UNBOXED] = "BINARY_OP_MULTIPLY_INT_UNBOXED",
    [BINARY_OP_SUBTRACT_FLOAT] = "BINARY_OP_SUBTRACT_FLOAT",
    [BINARY_OP_SUBTRACT_INT] = "BINARY_OP_SUBTRACT_INT",
    [BINARY_OP_SUBTRACT_INT_UNBOXED] = "BINARY_OP_SUBTRACT_INT_UNBOXED",
    ...
    [COMPARE_OP_INT_UNBOXED] = "COMPARE_OP_INT_UNBOXED",
...
const uint8_t _PyOpcode_Deopt[256] = {
    ...
    [BINARY_OP_ADD_INT_UNBOXED] = BINARY_OP,
    [BINARY_OP_ADD_UNICODE] = BINARY_OP,
    [BINARY_OP_INPLACE_ADD_UNICODE] = BINARY_OP,
    [BINARY_OP_MULTIPLY_FLOAT] = BINARY_OP,
    [BINARY_OP_MULTIPLY_INT] = BINARY_OP,
    [BINARY_OP_MULTIPLY_INT_UNBOXED] = BINARY_OP,
    [BINARY_OP_SUBTRACT_FLOAT] = BINARY_OP,
    [BINARY_OP_SUBTRACT_INT] = BINARY_OP,
    [BINARY_OP_SUBTRACT_INT_UNBOXED] = BINARY_OP,
    [BINARY_SLICE] = BINARY_SLICE,
    [BINARY_SUBSCR] = BINARY_SUBSCR,
    ...
    [COMPARE_OP_INT_UNBOXED] = COMPARE_OP,
