...
_PyOpcode_macro_expansion[256] = {
    ...
    [FOR_ITER_LIST] = { .nuops = 3, .uops = { { _ITER_CHECK_LIST, OPARG_SIMPLE, 1 }, { _ITER_JUMP_LIST, OPARG_SIMPLE, 1 }, { _ITER_NEXT_LIST, OPARG_REPLACED, 1 } } },
    [FOR_ITER_RANGE] = { .nuops = 3, .uops = { { _ITER_CHECK_RANGE, OPARG_SIMPLE, 1 }, { _ITER_JUMP_RANGE, OPARG_SIMPLE, 1 }, { _ITER_NEXT_RANGE, OPARG_SIMPLE, 1 } } },
