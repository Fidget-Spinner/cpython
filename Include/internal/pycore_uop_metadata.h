...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_CHECK_PEP_523____CHECK_CALL_BOUND_METHOD_EXACT_ARGS____INIT_CALL_BOUND_METHOD_EXACT_ARGS____CHECK_FUNCTION_VERSION____CHECK_FUNCTION_EXACT_ARGS____CHECK_STACK_SPACE____INIT_CALL_PY_EXACT_ARGS____PUSH_FRAME] = "_CHECK_PEP_523____CHECK_CALL_BOUND_METHOD_EXACT_ARGS____INIT_CALL_BOUND_METHOD_EXACT_ARGS____CHECK_FUNCTION_VERSION____CHECK_FUNCTION_EXACT_ARGS____CHECK_STACK_SPACE____INIT_CALL_PY_EXACT_ARGS____PUSH_FRAME",
                    ...
                    if (this_instr[4].opcode == _CHECK_FUNCTION_EXACT_ARGS) { 
                        if (this_instr[5].opcode == _CHECK_STACK_SPACE) { 
                            if (this_instr[6].opcode == _INIT_CALL_PY_EXACT_ARGS) { 
                                if (this_instr[7].opcode == _PUSH_FRAME) { 
                                    *move_forward_by = 8;
                                    return _CHECK_PEP_523____CHECK_CALL_BOUND_METHOD_EXACT_ARGS____INIT_CALL_BOUND_METHOD_EXACT_ARGS____CHECK_FUNCTION_VERSION____CHECK_FUNCTION_EXACT_ARGS____CHECK_STACK_SPACE____INIT_CALL_PY_EXACT_ARGS____PUSH_FRAME;
                                }
                            }
                        }
                    }
