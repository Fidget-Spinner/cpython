...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_GUARD_BOTH_INT_UNBOXED] = HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [_GUARD_NOS_INT] = HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [_GUARD_TOS_INT] = HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [_BINARY_OP_MULTIPLY_INT_UNBOXED] = HAS_DEOPT_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_ADD_INT_UNBOXED] = HAS_DEOPT_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_SUBTRACT_INT_UNBOXED] = HAS_DEOPT_FLAG | HAS_PURE_FLAG,
    ...
    [_COMPARE_OP_INT_UNBOXED] = HAS_ARG_FLAG,
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_GUARD_BOTH_INT_UNBOXED] = "_GUARD_BOTH_INT_UNBOXED",
