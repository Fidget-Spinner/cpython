...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_LOAD_FAST_CHECK__REG] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_ERROR_FLAG,
    [_LOAD_FAST_0__REG] = HAS_LOCAL_FLAG | HAS_PURE_FLAG,
    [_LOAD_FAST_1__REG] = HAS_LOCAL_FLAG | HAS_PURE_FLAG,
    [_LOAD_FAST_2__REG] = HAS_LOCAL_FLAG | HAS_PURE_FLAG,
    [_LOAD_FAST_3__REG] = HAS_LOCAL_FLAG | HAS_PURE_FLAG,
    [_LOAD_FAST_4__REG] = HAS_LOCAL_FLAG | HAS_PURE_FLAG,
    [_LOAD_FAST_5__REG] = HAS_LOCAL_FLAG | HAS_PURE_FLAG,
    [_LOAD_FAST_6__REG] = HAS_LOCAL_FLAG | HAS_PURE_FLAG,
    [_LOAD_FAST_7__REG] = HAS_LOCAL_FLAG | HAS_PURE_FLAG,
    [_LOAD_FAST__REG] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_PURE_FLAG,
    [_LOAD_FAST_AND_CLEAR__REG] = HAS_ARG_FLAG | HAS_LOCAL_FLAG,
    [_LOAD_FAST_LOAD_FAST__REG] = HAS_ARG_FLAG | HAS_LOCAL_FLAG,
    [_LOAD_CONST__REG] = HAS_ARG_FLAG | HAS_CONST_FLAG | HAS_PURE_FLAG,
    [_STORE_FAST_0__REG] = HAS_LOCAL_FLAG,
    [_STORE_FAST_1__REG] = HAS_LOCAL_FLAG,
    [_STORE_FAST_2__REG] = HAS_LOCAL_FLAG,
    [_STORE_FAST_3__REG] = HAS_LOCAL_FLAG,
    [_STORE_FAST_4__REG] = HAS_LOCAL_FLAG,
    [_STORE_FAST_5__REG] = HAS_LOCAL_FLAG,
    [_STORE_FAST_6__REG] = HAS_LOCAL_FLAG,
    [_STORE_FAST_7__REG] = HAS_LOCAL_FLAG,
    [_STORE_FAST__REG] = HAS_ARG_FLAG | HAS_LOCAL_FLAG,
    [_STORE_FAST_LOAD_FAST__REG] = HAS_ARG_FLAG | HAS_LOCAL_FLAG,
    [_STORE_FAST_STORE_FAST__REG] = HAS_ARG_FLAG | HAS_LOCAL_FLAG,
    [_POP_TOP__REG] = HAS_PURE_FLAG,
    [_PUSH_NULL__REG] = HAS_PURE_FLAG,
    [_END_SEND__REG] = HAS_PURE_FLAG,
    [_UNARY_NEGATIVE__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_UNARY_NOT__REG] = HAS_PURE_FLAG,
    [_TO_BOOL__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_TO_BOOL_BOOL__REG] = HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_TO_BOOL_INT__REG] = HAS_DEOPT_FLAG | HAS_EXIT_FLAG,
    [_TO_BOOL_LIST__REG] = HAS_DEOPT_FLAG | HAS_EXIT_FLAG,
    [_TO_BOOL_NONE__REG] = HAS_DEOPT_FLAG | HAS_EXIT_FLAG,
    [_TO_BOOL_STR__REG] = HAS_DEOPT_FLAG | HAS_EXIT_FLAG,
    [_REPLACE_WITH_TRUE__REG] = 0,
    [_UNARY_INVERT__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_GUARD_BOTH_INT__REG] = HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_BINARY_OP_MULTIPLY_INT__REG] = HAS_ERROR_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_ADD_INT__REG] = HAS_ERROR_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_SUBTRACT_INT__REG] = HAS_ERROR_FLAG | HAS_PURE_FLAG,
    [_GUARD_BOTH_FLOAT__REG] = HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_BINARY_OP_MULTIPLY_FLOAT__REG] = HAS_PURE_FLAG,
    [_BINARY_OP_ADD_FLOAT__REG] = HAS_PURE_FLAG,
    [_BINARY_OP_SUBTRACT_FLOAT__REG] = HAS_PURE_FLAG,
    [_GUARD_BOTH_UNICODE__REG] = HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_BINARY_OP_ADD_UNICODE__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_BINARY_SUBSCR__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_BINARY_SLICE__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_STORE_SLICE__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_BINARY_SUBSCR_LIST_INT__REG] = HAS_DEOPT_FLAG,
    [_BINARY_SUBSCR_STR_INT__REG] = HAS_DEOPT_FLAG,
    [_BINARY_SUBSCR_TUPLE_INT__REG] = HAS_DEOPT_FLAG,
    [_BINARY_SUBSCR_DICT__REG] = HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LIST_APPEND__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG,
    [_SET_ADD__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_STORE_SUBSCR__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_STORE_SUBSCR_LIST_INT__REG] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_STORE_SUBSCR_DICT__REG] = HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_DELETE_SUBSCR__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CALL_INTRINSIC_1__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CALL_INTRINSIC_2__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_POP_FRAME__REG] = HAS_ESCAPES_FLAG,
    [_GET_AITER__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_GET_ANEXT__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_GET_AWAITABLE__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_POP_EXCEPT__REG] = HAS_ESCAPES_FLAG,
    [_LOAD_ASSERTION_ERROR__REG] = 0,
    [_LOAD_BUILD_CLASS__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_STORE_NAME__REG] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_UNPACK_SEQUENCE__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_UNPACK_SEQUENCE_TWO_TUPLE__REG] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    [_UNPACK_SEQUENCE_TUPLE__REG] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    [_UNPACK_SEQUENCE_LIST__REG] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    [_UNPACK_EX__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_STORE_ATTR__REG] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_DELETE_ATTR__REG] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_STORE_GLOBAL__REG] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_LOCALS__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_FROM_DICT_OR_GLOBALS__REG] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_NAME__REG] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_GLOBAL__REG] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_GLOBAL_MODULE__REG] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    [_LOAD_GLOBAL_BUILTINS__REG] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    [_LOAD_FROM_DICT_OR_DEREF__REG] = HAS_ARG_FLAG | HAS_FREE_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_DEREF__REG] = HAS_ARG_FLAG | HAS_FREE_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_STORE_DEREF__REG] = HAS_ARG_FLAG | HAS_FREE_FLAG | HAS_ESCAPES_FLAG,
    [_BUILD_STRING__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_BUILD_TUPLE__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_BUILD_LIST__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LIST_EXTEND__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_SET_UPDATE__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_BUILD_SET__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_BUILD_MAP__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_BUILD_CONST_KEY_MAP__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_DICT_UPDATE__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_DICT_MERGE__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_MAP_ADD__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_SUPER_ATTR_ATTR__REG] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_SUPER_ATTR_METHOD__REG] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_ATTR__REG] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_GUARD_TYPE_VERSION__REG] = HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_CHECK_MANAGED_OBJECT_HAS_VALUES__REG] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_LOAD_ATTR_INSTANCE_VALUE_0__REG] = HAS_DEOPT_FLAG,
    [_LOAD_ATTR_INSTANCE_VALUE_1__REG] = HAS_DEOPT_FLAG,
    [_LOAD_ATTR_INSTANCE_VALUE__REG] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_OPARG_AND_1_FLAG,
    [_CHECK_ATTR_MODULE__REG] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_LOAD_ATTR_MODULE__REG] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    [_CHECK_ATTR_WITH_HINT__REG] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG | HAS_PASSTHROUGH_FLAG,
    [_LOAD_ATTR_WITH_HINT__REG] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_ATTR_SLOT_0__REG] = HAS_DEOPT_FLAG,
    [_LOAD_ATTR_SLOT_1__REG] = HAS_DEOPT_FLAG,
    [_LOAD_ATTR_SLOT__REG] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_OPARG_AND_1_FLAG,
    [_CHECK_ATTR_CLASS__REG] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_LOAD_ATTR_CLASS_0__REG] = 0,
    [_LOAD_ATTR_CLASS_1__REG] = 0,
    [_LOAD_ATTR_CLASS__REG] = HAS_ARG_FLAG | HAS_OPARG_AND_1_FLAG,
    [_GUARD_DORV_VALUES__REG] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_STORE_ATTR_INSTANCE_VALUE__REG] = HAS_ESCAPES_FLAG,
    [_STORE_ATTR_SLOT__REG] = HAS_ESCAPES_FLAG,
    [_COMPARE_OP__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_COMPARE_OP_FLOAT__REG] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG,
    [_COMPARE_OP_INT__REG] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_COMPARE_OP_STR__REG] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG,
    [_IS_OP__REG] = HAS_ARG_FLAG,
    [_CONTAINS_OP__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CONTAINS_OP_SET__REG] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CONTAINS_OP_DICT__REG] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CHECK_EG_MATCH__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CHECK_EXC_MATCH__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_IS_NONE__REG] = 0,
    [_GET_LEN__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_MATCH_CLASS__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_MATCH_MAPPING__REG] = 0,
    [_MATCH_SEQUENCE__REG] = 0,
    [_MATCH_KEYS__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_GET_ITER__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_GET_YIELD_FROM_ITER__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_FOR_ITER_TIER_TWO__REG] = HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_ITER_CHECK_LIST__REG] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_GUARD_NOT_EXHAUSTED_LIST__REG] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_ITER_NEXT_LIST__REG] = 0,
    [_ITER_CHECK_TUPLE__REG] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_GUARD_NOT_EXHAUSTED_TUPLE__REG] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_ITER_NEXT_TUPLE__REG] = 0,
    [_ITER_CHECK_RANGE__REG] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_GUARD_NOT_EXHAUSTED_RANGE__REG] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_ITER_NEXT_RANGE__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_BEFORE_ASYNC_WITH__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_BEFORE_WITH__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_WITH_EXCEPT_START__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_PUSH_EXC_INFO__REG] = 0,
    [_GUARD_DORV_VALUES_INST_ATTR_FROM_DICT__REG] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_GUARD_KEYS_VERSION__REG] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_LOAD_ATTR_METHOD_WITH_VALUES__REG] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_ATTR_METHOD_NO_DICT__REG] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_ATTR_NONDESCRIPTOR_WITH_VALUES__REG] = HAS_ARG_FLAG,
    [_LOAD_ATTR_NONDESCRIPTOR_NO_DICT__REG] = HAS_ARG_FLAG,
    [_CHECK_ATTR_METHOD_LAZY_DICT__REG] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_LOAD_ATTR_METHOD_LAZY_DICT__REG] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG,
    [_CHECK_CALL_BOUND_METHOD_EXACT_ARGS__REG] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_INIT_CALL_BOUND_METHOD_EXACT_ARGS__REG] = HAS_ARG_FLAG,
    [_CHECK_FUNCTION_EXACT_ARGS__REG] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_CHECK_STACK_SPACE__REG] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_INIT_CALL_PY_EXACT_ARGS_0__REG] = HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_INIT_CALL_PY_EXACT_ARGS_1__REG] = HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_INIT_CALL_PY_EXACT_ARGS_2__REG] = HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_INIT_CALL_PY_EXACT_ARGS_3__REG] = HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_INIT_CALL_PY_EXACT_ARGS_4__REG] = HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_INIT_CALL_PY_EXACT_ARGS__REG] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_PUSH_FRAME__REG] = HAS_ESCAPES_FLAG,
    [_CALL_TYPE_1__REG] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    [_CALL_STR_1__REG] = HAS_ARG_FLAG | HAS_EVAL_BREAK_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CALL_TUPLE_1__REG] = HAS_ARG_FLAG | HAS_EVAL_BREAK_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_EXIT_INIT_CHECK__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CALL_BUILTIN_CLASS__REG] = HAS_ARG_FLAG | HAS_EVAL_BREAK_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG,
    [_CALL_BUILTIN_O__REG] = HAS_ARG_FLAG | HAS_EVAL_BREAK_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CALL_BUILTIN_FAST__REG] = HAS_ARG_FLAG | HAS_EVAL_BREAK_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CALL_BUILTIN_FAST_WITH_KEYWORDS__REG] = HAS_ARG_FLAG | HAS_EVAL_BREAK_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CALL_LEN__REG] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CALL_ISINSTANCE__REG] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CALL_METHOD_DESCRIPTOR_O__REG] = HAS_ARG_FLAG | HAS_EVAL_BREAK_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS__REG] = HAS_ARG_FLAG | HAS_EVAL_BREAK_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CALL_METHOD_DESCRIPTOR_NOARGS__REG] = HAS_ARG_FLAG | HAS_EVAL_BREAK_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CALL_METHOD_DESCRIPTOR_FAST__REG] = HAS_ARG_FLAG | HAS_EVAL_BREAK_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_MAKE_FUNCTION__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_SET_FUNCTION_ATTRIBUTE__REG] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG,
    [_BUILD_SLICE__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CONVERT_VALUE__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG,
    [_FORMAT_SIMPLE__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_FORMAT_WITH_SPEC__REG] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_COPY__REG] = HAS_ARG_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP__REG] = HAS_ARG_FLAG | HAS_ERROR_FLAG,
    [_SWAP__REG] = HAS_ARG_FLAG | HAS_PURE_FLAG,
    [_GUARD_IS_TRUE_POP__REG] = HAS_DEOPT_FLAG | HAS_EXIT_FLAG,
    [_GUARD_IS_FALSE_POP__REG] = HAS_DEOPT_FLAG | HAS_EXIT_FLAG,
    [_GUARD_IS_NONE_POP__REG] = HAS_DEOPT_FLAG | HAS_EXIT_FLAG,
    [_GUARD_IS_NOT_NONE_POP__REG] = HAS_DEOPT_FLAG | HAS_EXIT_FLAG,
    [_LOAD_CONST_INLINE__REG] = HAS_PURE_FLAG,
    [_LOAD_CONST_INLINE_BORROW__REG] = HAS_PURE_FLAG,
    [_POP_TOP_LOAD_CONST_INLINE_BORROW__REG] = HAS_PURE_FLAG,
    [_LOAD_CONST_INLINE_WITH_NULL__REG] = HAS_PURE_FLAG,
    [_LOAD_CONST_INLINE_BORROW_WITH_NULL__REG] = HAS_PURE_FLAG,
    [_INTERNAL_INCREMENT_OPT_COUNTER__REG] = 0,
};
