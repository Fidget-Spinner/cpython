...
const uint32_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [INSTRUMENTED_POP_JUMP_IF_NONE] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG,
    [INSTRUMENTED_POP_JUMP_IF_NOT_NONE] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG,
    ...
    [BINARY_OP_INPLACE_ADD_UNICODE] = HAS_LOCAL_FLAG | HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    ...
    [CALL_FUNCTION_EX] = HAS_EVAL_BREAK_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    [INSTRUMENTED_CALL_FUNCTION_EX] = HAS_EVAL_BREAK_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
