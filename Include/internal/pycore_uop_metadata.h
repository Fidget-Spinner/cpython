...
const uint32_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_THIRD_TO_FLOAT] = HAS_ERROR_FLAG,
    [_TOS_TO_TAGGED_DOUBLE] = HAS_EXIT_FLAG,
    [_NOS_TO_TAGGED_DOUBLE] = HAS_EXIT_FLAG,
    [_THIRD_TO_TAGGED_DOUBLE] = HAS_EXIT_FLAG,
    [_BINARY_OP_MULTIPLY_TAGGED_DOUBLE] = HAS_EXIT_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_ADD_TAGGED_DOUBLE] = HAS_EXIT_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_SUBTRACT_TAGGED_DOUBLE] = HAS_EXIT_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_MULTIPLY_FLOAT_OUT_TAGGED_DOUBLE] = HAS_EXIT_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_ADD_FLOAT_OUT_TAGGED_DOUBLE] = HAS_EXIT_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_SUBTRACT_FLOAT_OUT_TAGGED_DOUBLE] = HAS_EXIT_FLAG | HAS_PURE_FLAG,
};
...
const _PyUopCachingInfo _PyUop_Caching[MAX_UOP_ID+1] = {
    ...
    [_THIRD_TO_FLOAT] = {
        .best = { 0, 1, 2, 3 },
        .entries = {
            { 3, 0, _THIRD_TO_FLOAT_r03 },
            { 3, 1, _THIRD_TO_FLOAT_r13 },
            { 3, 2, _THIRD_TO_FLOAT_r23 },
            { 3, 3, _THIRD_TO_FLOAT_r33 },
        },
    },
    [_TOS_TO_TAGGED_DOUBLE] = {
        .best = { 0, 1, 2, 3 },
        .entries = {
            { 1, 0, _TOS_TO_TAGGED_DOUBLE_r01 },
            { 1, 1, _TOS_TO_TAGGED_DOUBLE_r11 },
            { 2, 2, _TOS_TO_TAGGED_DOUBLE_r22 },
            { 3, 3, _TOS_TO_TAGGED_DOUBLE_r33 },
        },
    },
    [_NOS_TO_TAGGED_DOUBLE] = {
        .best = { 0, 1, 2, 3 },
        .entries = {
            { 2, 0, _NOS_TO_TAGGED_DOUBLE_r02 },
            { 2, 1, _NOS_TO_TAGGED_DOUBLE_r12 },
            { 2, 2, _NOS_TO_TAGGED_DOUBLE_r22 },
            { 3, 3, _NOS_TO_TAGGED_DOUBLE_r33 },
        },
    },
    [_THIRD_TO_TAGGED_DOUBLE] = {
        .best = { 0, 1, 2, 3 },
        .entries = {
            { 3, 0, _THIRD_TO_TAGGED_DOUBLE_r03 },
            { 3, 1, _THIRD_TO_TAGGED_DOUBLE_r13 },
            { 3, 2, _THIRD_TO_TAGGED_DOUBLE_r23 },
            { 3, 3, _THIRD_TO_TAGGED_DOUBLE_r33 },
        },
    },
    [_BINARY_OP_MULTIPLY_TAGGED_DOUBLE] = {
        .best = { 0, 1, 2, 2 },
        .entries = {
            { 3, 0, _BINARY_OP_MULTIPLY_TAGGED_DOUBLE_r03 },
            { 3, 1, _BINARY_OP_MULTIPLY_TAGGED_DOUBLE_r13 },
            { 3, 2, _BINARY_OP_MULTIPLY_TAGGED_DOUBLE_r23 },
            { -1, -1, -1 },
        },
    },
    [_BINARY_OP_ADD_TAGGED_DOUBLE] = {
        .best = { 0, 1, 2, 2 },
        .entries = {
            { 3, 0, _BINARY_OP_ADD_TAGGED_DOUBLE_r03 },
            { 3, 1, _BINARY_OP_ADD_TAGGED_DOUBLE_r13 },
            { 3, 2, _BINARY_OP_ADD_TAGGED_DOUBLE_r23 },
            { -1, -1, -1 },
        },
    },
    [_BINARY_OP_SUBTRACT_TAGGED_DOUBLE] = {
        .best = { 0, 1, 2, 2 },
        .entries = {
            { 3, 0, _BINARY_OP_SUBTRACT_TAGGED_DOUBLE_r03 },
            { 3, 1, _BINARY_OP_SUBTRACT_TAGGED_DOUBLE_r13 },
            { 3, 2, _BINARY_OP_SUBTRACT_TAGGED_DOUBLE_r23 },
            { -1, -1, -1 },
        },
    },
    [_BINARY_OP_MULTIPLY_FLOAT_OUT_TAGGED_DOUBLE] = {
        .best = { 0, 1, 2, 2 },
        .entries = {
            { 3, 0, _BINARY_OP_MULTIPLY_FLOAT_OUT_TAGGED_DOUBLE_r03 },
            { 3, 1, _BINARY_OP_MULTIPLY_FLOAT_OUT_TAGGED_DOUBLE_r13 },
            { 3, 2, _BINARY_OP_MULTIPLY_FLOAT_OUT_TAGGED_DOUBLE_r23 },
            { -1, -1, -1 },
        },
    },
    [_BINARY_OP_ADD_FLOAT_OUT_TAGGED_DOUBLE] = {
        .best = { 0, 1, 2, 2 },
        .entries = {
            { 3, 0, _BINARY_OP_ADD_FLOAT_OUT_TAGGED_DOUBLE_r03 },
            { 3, 1, _BINARY_OP_ADD_FLOAT_OUT_TAGGED_DOUBLE_r13 },
            { 3, 2, _BINARY_OP_ADD_FLOAT_OUT_TAGGED_DOUBLE_r23 },
            { -1, -1, -1 },
        },
    },
    [_BINARY_OP_SUBTRACT_FLOAT_OUT_TAGGED_DOUBLE] = {
        .best = { 0, 1, 2, 2 },
        .entries = {
            { 3, 0, _BINARY_OP_SUBTRACT_FLOAT_OUT_TAGGED_DOUBLE_r03 },
            { 3, 1, _BINARY_OP_SUBTRACT_FLOAT_OUT_TAGGED_DOUBLE_r13 },
            { 3, 2, _BINARY_OP_SUBTRACT_FLOAT_OUT_TAGGED_DOUBLE_r23 },
            { -1, -1, -1 },
        },
    },
};
...
const uint16_t _PyUop_Uncached[MAX_UOP_REGS_ID+1] = {
    ...
    [_THIRD_TO_FLOAT_r03] = _THIRD_TO_FLOAT,
    [_THIRD_TO_FLOAT_r13] = _THIRD_TO_FLOAT,
    [_THIRD_TO_FLOAT_r23] = _THIRD_TO_FLOAT,
    [_THIRD_TO_FLOAT_r33] = _THIRD_TO_FLOAT,
    [_TOS_TO_TAGGED_DOUBLE_r01] = _TOS_TO_TAGGED_DOUBLE,
    [_TOS_TO_TAGGED_DOUBLE_r11] = _TOS_TO_TAGGED_DOUBLE,
    [_TOS_TO_TAGGED_DOUBLE_r22] = _TOS_TO_TAGGED_DOUBLE,
    [_TOS_TO_TAGGED_DOUBLE_r33] = _TOS_TO_TAGGED_DOUBLE,
    [_NOS_TO_TAGGED_DOUBLE_r02] = _NOS_TO_TAGGED_DOUBLE,
    [_NOS_TO_TAGGED_DOUBLE_r12] = _NOS_TO_TAGGED_DOUBLE,
    [_NOS_TO_TAGGED_DOUBLE_r22] = _NOS_TO_TAGGED_DOUBLE,
    [_NOS_TO_TAGGED_DOUBLE_r33] = _NOS_TO_TAGGED_DOUBLE,
    [_THIRD_TO_TAGGED_DOUBLE_r03] = _THIRD_TO_TAGGED_DOUBLE,
    [_THIRD_TO_TAGGED_DOUBLE_r13] = _THIRD_TO_TAGGED_DOUBLE,
    [_THIRD_TO_TAGGED_DOUBLE_r23] = _THIRD_TO_TAGGED_DOUBLE,
    [_THIRD_TO_TAGGED_DOUBLE_r33] = _THIRD_TO_TAGGED_DOUBLE,
    [_BINARY_OP_MULTIPLY_TAGGED_DOUBLE_r03] = _BINARY_OP_MULTIPLY_TAGGED_DOUBLE,
    [_BINARY_OP_MULTIPLY_TAGGED_DOUBLE_r13] = _BINARY_OP_MULTIPLY_TAGGED_DOUBLE,
    [_BINARY_OP_MULTIPLY_TAGGED_DOUBLE_r23] = _BINARY_OP_MULTIPLY_TAGGED_DOUBLE,
    [_BINARY_OP_ADD_TAGGED_DOUBLE_r03] = _BINARY_OP_ADD_TAGGED_DOUBLE,
    [_BINARY_OP_ADD_TAGGED_DOUBLE_r13] = _BINARY_OP_ADD_TAGGED_DOUBLE,
    [_BINARY_OP_ADD_TAGGED_DOUBLE_r23] = _BINARY_OP_ADD_TAGGED_DOUBLE,
    [_BINARY_OP_SUBTRACT_TAGGED_DOUBLE_r03] = _BINARY_OP_SUBTRACT_TAGGED_DOUBLE,
    [_BINARY_OP_SUBTRACT_TAGGED_DOUBLE_r13] = _BINARY_OP_SUBTRACT_TAGGED_DOUBLE,
    [_BINARY_OP_SUBTRACT_TAGGED_DOUBLE_r23] = _BINARY_OP_SUBTRACT_TAGGED_DOUBLE,
    [_BINARY_OP_MULTIPLY_FLOAT_OUT_TAGGED_DOUBLE_r03] = _BINARY_OP_MULTIPLY_FLOAT_OUT_TAGGED_DOUBLE,
    [_BINARY_OP_MULTIPLY_FLOAT_OUT_TAGGED_DOUBLE_r13] = _BINARY_OP_MULTIPLY_FLOAT_OUT_TAGGED_DOUBLE,
    [_BINARY_OP_MULTIPLY_FLOAT_OUT_TAGGED_DOUBLE_r23] = _BINARY_OP_MULTIPLY_FLOAT_OUT_TAGGED_DOUBLE,
    [_BINARY_OP_ADD_FLOAT_OUT_TAGGED_DOUBLE_r03] = _BINARY_OP_ADD_FLOAT_OUT_TAGGED_DOUBLE,
    [_BINARY_OP_ADD_FLOAT_OUT_TAGGED_DOUBLE_r13] = _BINARY_OP_ADD_FLOAT_OUT_TAGGED_DOUBLE,
    [_BINARY_OP_ADD_FLOAT_OUT_TAGGED_DOUBLE_r23] = _BINARY_OP_ADD_FLOAT_OUT_TAGGED_DOUBLE,
    [_BINARY_OP_SUBTRACT_FLOAT_OUT_TAGGED_DOUBLE_r03] = _BINARY_OP_SUBTRACT_FLOAT_OUT_TAGGED_DOUBLE,
    [_BINARY_OP_SUBTRACT_FLOAT_OUT_TAGGED_DOUBLE_r13] = _BINARY_OP_SUBTRACT_FLOAT_OUT_TAGGED_DOUBLE,
    [_BINARY_OP_SUBTRACT_FLOAT_OUT_TAGGED_DOUBLE_r23] = _BINARY_OP_SUBTRACT_FLOAT_OUT_TAGGED_DOUBLE,
};
...
const char *const _PyOpcode_uop_name[MAX_UOP_REGS_ID+1] = {
    ...
    [_BINARY_OP_ADD_FLOAT_OUT_TAGGED_DOUBLE] = "_BINARY_OP_ADD_FLOAT_OUT_TAGGED_DOUBLE",
    [_BINARY_OP_ADD_FLOAT_OUT_TAGGED_DOUBLE_r03] = "_BINARY_OP_ADD_FLOAT_OUT_TAGGED_DOUBLE_r03",
    [_BINARY_OP_ADD_FLOAT_OUT_TAGGED_DOUBLE_r13] = "_BINARY_OP_ADD_FLOAT_OUT_TAGGED_DOUBLE_r13",
    [_BINARY_OP_ADD_FLOAT_OUT_TAGGED_DOUBLE_r23] = "_BINARY_OP_ADD_FLOAT_OUT_TAGGED_DOUBLE_r23",
    ...
    [_BINARY_OP_ADD_TAGGED_DOUBLE] = "_BINARY_OP_ADD_TAGGED_DOUBLE",
    [_BINARY_OP_ADD_TAGGED_DOUBLE_r03] = "_BINARY_OP_ADD_TAGGED_DOUBLE_r03",
    [_BINARY_OP_ADD_TAGGED_DOUBLE_r13] = "_BINARY_OP_ADD_TAGGED_DOUBLE_r13",
    [_BINARY_OP_ADD_TAGGED_DOUBLE_r23] = "_BINARY_OP_ADD_TAGGED_DOUBLE_r23",
    ...
    [_BINARY_OP_MULTIPLY_FLOAT_OUT_TAGGED_DOUBLE] = "_BINARY_OP_MULTIPLY_FLOAT_OUT_TAGGED_DOUBLE",
    [_BINARY_OP_MULTIPLY_FLOAT_OUT_TAGGED_DOUBLE_r03] = "_BINARY_OP_MULTIPLY_FLOAT_OUT_TAGGED_DOUBLE_r03",
    [_BINARY_OP_MULTIPLY_FLOAT_OUT_TAGGED_DOUBLE_r13] = "_BINARY_OP_MULTIPLY_FLOAT_OUT_TAGGED_DOUBLE_r13",
    [_BINARY_OP_MULTIPLY_FLOAT_OUT_TAGGED_DOUBLE_r23] = "_BINARY_OP_MULTIPLY_FLOAT_OUT_TAGGED_DOUBLE_r23",
    ...
    [_BINARY_OP_MULTIPLY_TAGGED_DOUBLE] = "_BINARY_OP_MULTIPLY_TAGGED_DOUBLE",
    [_BINARY_OP_MULTIPLY_TAGGED_DOUBLE_r03] = "_BINARY_OP_MULTIPLY_TAGGED_DOUBLE_r03",
    [_BINARY_OP_MULTIPLY_TAGGED_DOUBLE_r13] = "_BINARY_OP_MULTIPLY_TAGGED_DOUBLE_r13",
    [_BINARY_OP_MULTIPLY_TAGGED_DOUBLE_r23] = "_BINARY_OP_MULTIPLY_TAGGED_DOUBLE_r23",
    ...
    [_BINARY_OP_SUBTRACT_FLOAT_OUT_TAGGED_DOUBLE] = "_BINARY_OP_SUBTRACT_FLOAT_OUT_TAGGED_DOUBLE",
    [_BINARY_OP_SUBTRACT_FLOAT_OUT_TAGGED_DOUBLE_r03] = "_BINARY_OP_SUBTRACT_FLOAT_OUT_TAGGED_DOUBLE_r03",
    [_BINARY_OP_SUBTRACT_FLOAT_OUT_TAGGED_DOUBLE_r13] = "_BINARY_OP_SUBTRACT_FLOAT_OUT_TAGGED_DOUBLE_r13",
    [_BINARY_OP_SUBTRACT_FLOAT_OUT_TAGGED_DOUBLE_r23] = "_BINARY_OP_SUBTRACT_FLOAT_OUT_TAGGED_DOUBLE_r23",
    ...
    [_BINARY_OP_SUBTRACT_TAGGED_DOUBLE] = "_BINARY_OP_SUBTRACT_TAGGED_DOUBLE",
    [_BINARY_OP_SUBTRACT_TAGGED_DOUBLE_r03] = "_BINARY_OP_SUBTRACT_TAGGED_DOUBLE_r03",
    [_BINARY_OP_SUBTRACT_TAGGED_DOUBLE_r13] = "_BINARY_OP_SUBTRACT_TAGGED_DOUBLE_r13",
    [_BINARY_OP_SUBTRACT_TAGGED_DOUBLE_r23] = "_BINARY_OP_SUBTRACT_TAGGED_DOUBLE_r23",
    ...
    [_NOP_r22] = "_NOP_r22",
    [_NOP_r33] = "_NOP_r33",
    [_NOS_TO_TAGGED_DOUBLE] = "_NOS_TO_TAGGED_DOUBLE",
    [_NOS_TO_TAGGED_DOUBLE_r02] = "_NOS_TO_TAGGED_DOUBLE_r02",
    [_NOS_TO_TAGGED_DOUBLE_r12] = "_NOS_TO_TAGGED_DOUBLE_r12",
    [_NOS_TO_TAGGED_DOUBLE_r22] = "_NOS_TO_TAGGED_DOUBLE_r22",
    [_NOS_TO_TAGGED_DOUBLE_r33] = "_NOS_TO_TAGGED_DOUBLE_r33",
    [_POP_CALL] = "_POP_CALL",
    ...
    [_THIRD_TO_FLOAT] = "_THIRD_TO_FLOAT",
    [_THIRD_TO_FLOAT_r03] = "_THIRD_TO_FLOAT_r03",
    [_THIRD_TO_FLOAT_r13] = "_THIRD_TO_FLOAT_r13",
    [_THIRD_TO_FLOAT_r23] = "_THIRD_TO_FLOAT_r23",
    [_THIRD_TO_FLOAT_r33] = "_THIRD_TO_FLOAT_r33",
    [_THIRD_TO_TAGGED_DOUBLE] = "_THIRD_TO_TAGGED_DOUBLE",
    [_THIRD_TO_TAGGED_DOUBLE_r03] = "_THIRD_TO_TAGGED_DOUBLE_r03",
    [_THIRD_TO_TAGGED_DOUBLE_r13] = "_THIRD_TO_TAGGED_DOUBLE_r13",
    [_THIRD_TO_TAGGED_DOUBLE_r23] = "_THIRD_TO_TAGGED_DOUBLE_r23",
    [_THIRD_TO_TAGGED_DOUBLE_r33] = "_THIRD_TO_TAGGED_DOUBLE_r33",
    ...
    [_TOS_TO_TAGGED_DOUBLE] = "_TOS_TO_TAGGED_DOUBLE",
    [_TOS_TO_TAGGED_DOUBLE_r01] = "_TOS_TO_TAGGED_DOUBLE_r01",
    [_TOS_TO_TAGGED_DOUBLE_r11] = "_TOS_TO_TAGGED_DOUBLE_r11",
    [_TOS_TO_TAGGED_DOUBLE_r22] = "_TOS_TO_TAGGED_DOUBLE_r22",
    [_TOS_TO_TAGGED_DOUBLE_r33] = "_TOS_TO_TAGGED_DOUBLE_r33",
    [_TO_BOOL] = "_TO_BOOL",
