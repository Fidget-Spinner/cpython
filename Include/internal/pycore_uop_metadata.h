...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_BINARY_OP_NO_ESCAPE] = HAS_ARG_FLAG | HAS_ERROR_FLAG,
    ...
    [_CHECK_FUNCTION_UNMODIFIED] = HAS_DEOPT_FLAG,
    ...
    [_SET_DATASTACK_TOP] = HAS_ARG_FLAG,
    [_SET_TOS_TO_FRAME] = 0,
    [_RECONSTRUCT_FRAME] = HAS_ARG_FLAG,
    [_REHYDRATE_FRAME] = HAS_ARG_FLAG,
    [_SET_TOPMOST_FRAME_AND_SHRINK_STACK] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG,
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_CHECK_FUNCTION_UNMODIFIED] = "_CHECK_FUNCTION_UNMODIFIED",
