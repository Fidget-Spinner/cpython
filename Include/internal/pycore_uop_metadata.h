...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_TO_BOOL_INT_UNBOXED] = HAS_ESCAPES_FLAG,
    ...
    [_UNBOX_FAST_0] = HAS_LOCAL_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_UNBOX_FAST_1] = HAS_LOCAL_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_UNBOX_FAST_2] = HAS_LOCAL_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_UNBOX_FAST_3] = HAS_LOCAL_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_UNBOX_FAST_4] = HAS_LOCAL_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_UNBOX_FAST_5] = HAS_LOCAL_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_UNBOX_FAST_6] = HAS_LOCAL_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_BINARY_OP_SUBTRACT_INT_UNBOXED] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_REM_INT_UNBOXED] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_RSHIFT_INT_UNBOXED] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_XOR_INT_UNBOXED] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_LOAD_UNBOXED] = HAS_ESCAPES_FLAG,
    ...
    [_BINARY_OP_SUBSCR_LIST_INT_UNBOXED] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_BINARY_OP_SUBSCR_STR_INT] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_BINARY_OP_SUBSCR_STR_INT_UNBOXED] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_BINARY_OP_SUBSCR_TUPLE_INT] = HAS_DEOPT_FLAG,
    [_BINARY_OP_SUBSCR_TUPLE_INT_UNBOXED] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_STORE_SUBSCR_LIST_INT_UNBOXED] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_COMPARE_OP_INT_UNBOXED] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG,
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_BINARY_OP_ADD_INT_UNBOXED] = "_BINARY_OP_ADD_INT_UNBOXED",
    [_BINARY_OP_ADD_UNICODE] = "_BINARY_OP_ADD_UNICODE",
    [_BINARY_OP_AND_INT_UNBOXED] = "_BINARY_OP_AND_INT_UNBOXED",
    ...
    [_BINARY_OP_MULTIPLY_INT_UNBOXED] = "_BINARY_OP_MULTIPLY_INT_UNBOXED",
    [_BINARY_OP_REM_INT_UNBOXED] = "_BINARY_OP_REM_INT_UNBOXED",
    [_BINARY_OP_RSHIFT_INT_UNBOXED] = "_BINARY_OP_RSHIFT_INT_UNBOXED",
    ...
    [_BINARY_OP_SUBSCR_LIST_INT_UNBOXED] = "_BINARY_OP_SUBSCR_LIST_INT_UNBOXED",
    [_BINARY_OP_SUBSCR_STR_INT] = "_BINARY_OP_SUBSCR_STR_INT",
    [_BINARY_OP_SUBSCR_STR_INT_UNBOXED] = "_BINARY_OP_SUBSCR_STR_INT_UNBOXED",
    [_BINARY_OP_SUBSCR_TUPLE_INT] = "_BINARY_OP_SUBSCR_TUPLE_INT",
    [_BINARY_OP_SUBSCR_TUPLE_INT_UNBOXED] = "_BINARY_OP_SUBSCR_TUPLE_INT_UNBOXED",
    [_BINARY_OP_SUBTRACT_FLOAT] = "_BINARY_OP_SUBTRACT_FLOAT",
    [_BINARY_OP_SUBTRACT_INT] = "_BINARY_OP_SUBTRACT_INT",
    [_BINARY_OP_SUBTRACT_INT_UNBOXED] = "_BINARY_OP_SUBTRACT_INT_UNBOXED",
    [_BINARY_OP_XOR_INT_UNBOXED] = "_BINARY_OP_XOR_INT_UNBOXED",
    ...
    [_COMPARE_OP_INT_UNBOXED] = "_COMPARE_OP_INT_UNBOXED",
    ...
    [_ITER_NEXT_RANGE_UNBOXED] = "_ITER_NEXT_RANGE_UNBOXED",
    ...
    [_STORE_SUBSCR_LIST_INT_UNBOXED] = "_STORE_SUBSCR_LIST_INT_UNBOXED",
    [_SWAP] = "_SWAP",
    [_TIER2_RESUME_CHECK] = "_TIER2_RESUME_CHECK",
    [_TO_BOOL] = "_TO_BOOL",
    [_TO_BOOL_BOOL] = "_TO_BOOL_BOOL",
    [_TO_BOOL_INT] = "_TO_BOOL_INT",
    [_TO_BOOL_INT_UNBOXED] = "_TO_BOOL_INT_UNBOXED",
    ...
    [_UNBOX] = "_UNBOX",
    [_UNBOX_FAST] = "_UNBOX_FAST",
    [_UNBOX_FAST_0] = "_UNBOX_FAST_0",
    [_UNBOX_FAST_1] = "_UNBOX_FAST_1",
    [_UNBOX_FAST_2] = "_UNBOX_FAST_2",
    [_UNBOX_FAST_3] = "_UNBOX_FAST_3",
    [_UNBOX_FAST_4] = "_UNBOX_FAST_4",
    [_UNBOX_FAST_5] = "_UNBOX_FAST_5",
    [_UNBOX_FAST_6] = "_UNBOX_FAST_6",
    [_UNBOX_FAST_7] = "_UNBOX_FAST_7",
