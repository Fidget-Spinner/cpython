...
extern const uint16_t _PyUop_ToRegisterVer[MAX_UOP_ID+1];
#ifdef NEED_OPCODE_METADATA
const uint16_t _PyUop_ToRegisterVer[MAX_UOP_ID+1] = {
    [_LOAD_FAST_CHECK] = _LOAD_FAST_CHECK__REG,
    [_LOAD_FAST_0] = _LOAD_FAST_0__REG,
    [_LOAD_FAST_1] = _LOAD_FAST_1__REG,
    [_LOAD_FAST_2] = _LOAD_FAST_2__REG,
    [_LOAD_FAST_3] = _LOAD_FAST_3__REG,
    [_LOAD_FAST_4] = _LOAD_FAST_4__REG,
    [_LOAD_FAST_5] = _LOAD_FAST_5__REG,
    [_LOAD_FAST_6] = _LOAD_FAST_6__REG,
    [_LOAD_FAST_7] = _LOAD_FAST_7__REG,
    [_LOAD_FAST] = _LOAD_FAST__REG,
    [_LOAD_FAST_AND_CLEAR] = _LOAD_FAST_AND_CLEAR__REG,
    [_LOAD_FAST_LOAD_FAST] = _LOAD_FAST_LOAD_FAST__REG,
    [_LOAD_CONST] = _LOAD_CONST__REG,
    [_STORE_FAST_0] = _STORE_FAST_0__REG,
    [_STORE_FAST_1] = _STORE_FAST_1__REG,
    [_STORE_FAST_2] = _STORE_FAST_2__REG,
    [_STORE_FAST_3] = _STORE_FAST_3__REG,
    [_STORE_FAST_4] = _STORE_FAST_4__REG,
    [_STORE_FAST_5] = _STORE_FAST_5__REG,
    [_STORE_FAST_6] = _STORE_FAST_6__REG,
    [_STORE_FAST_7] = _STORE_FAST_7__REG,
    [_STORE_FAST] = _STORE_FAST__REG,
    [_STORE_FAST_LOAD_FAST] = _STORE_FAST_LOAD_FAST__REG,
    [_STORE_FAST_STORE_FAST] = _STORE_FAST_STORE_FAST__REG,
    [_POP_TOP] = _POP_TOP__REG,
    [_PUSH_NULL] = _PUSH_NULL__REG,
    [_END_SEND] = _END_SEND__REG,
    [_UNARY_NEGATIVE] = _UNARY_NEGATIVE__REG,
    [_UNARY_NOT] = _UNARY_NOT__REG,
    [_TO_BOOL] = _TO_BOOL__REG,
    [_TO_BOOL_BOOL] = _TO_BOOL_BOOL__REG,
    [_TO_BOOL_INT] = _TO_BOOL_INT__REG,
    [_TO_BOOL_LIST] = _TO_BOOL_LIST__REG,
    [_TO_BOOL_NONE] = _TO_BOOL_NONE__REG,
    [_TO_BOOL_STR] = _TO_BOOL_STR__REG,
    [_REPLACE_WITH_TRUE] = _REPLACE_WITH_TRUE__REG,
    [_UNARY_INVERT] = _UNARY_INVERT__REG,
    [_GUARD_BOTH_INT] = _GUARD_BOTH_INT__REG,
    [_BINARY_OP_MULTIPLY_INT] = _BINARY_OP_MULTIPLY_INT__REG,
    [_BINARY_OP_ADD_INT] = _BINARY_OP_ADD_INT__REG,
    [_BINARY_OP_SUBTRACT_INT] = _BINARY_OP_SUBTRACT_INT__REG,
    [_GUARD_BOTH_FLOAT] = _GUARD_BOTH_FLOAT__REG,
    [_BINARY_OP_MULTIPLY_FLOAT] = _BINARY_OP_MULTIPLY_FLOAT__REG,
    [_BINARY_OP_ADD_FLOAT] = _BINARY_OP_ADD_FLOAT__REG,
    [_BINARY_OP_SUBTRACT_FLOAT] = _BINARY_OP_SUBTRACT_FLOAT__REG,
    [_GUARD_BOTH_UNICODE] = _GUARD_BOTH_UNICODE__REG,
    [_BINARY_OP_ADD_UNICODE] = _BINARY_OP_ADD_UNICODE__REG,
    [_BINARY_SUBSCR] = _BINARY_SUBSCR__REG,
    [_BINARY_SLICE] = _BINARY_SLICE__REG,
    [_STORE_SLICE] = _STORE_SLICE__REG,
    [_BINARY_SUBSCR_LIST_INT] = _BINARY_SUBSCR_LIST_INT__REG,
    [_BINARY_SUBSCR_STR_INT] = _BINARY_SUBSCR_STR_INT__REG,
    [_BINARY_SUBSCR_TUPLE_INT] = _BINARY_SUBSCR_TUPLE_INT__REG,
    [_BINARY_SUBSCR_DICT] = _BINARY_SUBSCR_DICT__REG,
    [_LIST_APPEND] = _LIST_APPEND__REG,
    [_SET_ADD] = _SET_ADD__REG,
    [_STORE_SUBSCR] = _STORE_SUBSCR__REG,
    [_STORE_SUBSCR_LIST_INT] = _STORE_SUBSCR_LIST_INT__REG,
    [_STORE_SUBSCR_DICT] = _STORE_SUBSCR_DICT__REG,
    [_DELETE_SUBSCR] = _DELETE_SUBSCR__REG,
    [_CALL_INTRINSIC_1] = _CALL_INTRINSIC_1__REG,
    [_CALL_INTRINSIC_2] = _CALL_INTRINSIC_2__REG,
    [_POP_FRAME] = _POP_FRAME__REG,
    [_GET_AITER] = _GET_AITER__REG,
    [_GET_ANEXT] = _GET_ANEXT__REG,
    [_GET_AWAITABLE] = _GET_AWAITABLE__REG,
    [_POP_EXCEPT] = _POP_EXCEPT__REG,
    [_LOAD_ASSERTION_ERROR] = _LOAD_ASSERTION_ERROR__REG,
    [_LOAD_BUILD_CLASS] = _LOAD_BUILD_CLASS__REG,
    [_STORE_NAME] = _STORE_NAME__REG,
    [_UNPACK_SEQUENCE] = _UNPACK_SEQUENCE__REG,
    [_UNPACK_SEQUENCE_TWO_TUPLE] = _UNPACK_SEQUENCE_TWO_TUPLE__REG,
    [_UNPACK_SEQUENCE_TUPLE] = _UNPACK_SEQUENCE_TUPLE__REG,
    [_UNPACK_SEQUENCE_LIST] = _UNPACK_SEQUENCE_LIST__REG,
    [_UNPACK_EX] = _UNPACK_EX__REG,
    [_STORE_ATTR] = _STORE_ATTR__REG,
    [_DELETE_ATTR] = _DELETE_ATTR__REG,
    [_STORE_GLOBAL] = _STORE_GLOBAL__REG,
    [_LOAD_LOCALS] = _LOAD_LOCALS__REG,
    [_LOAD_FROM_DICT_OR_GLOBALS] = _LOAD_FROM_DICT_OR_GLOBALS__REG,
    [_LOAD_NAME] = _LOAD_NAME__REG,
    [_LOAD_GLOBAL] = _LOAD_GLOBAL__REG,
    [_LOAD_GLOBAL_MODULE] = _LOAD_GLOBAL_MODULE__REG,
    [_LOAD_GLOBAL_BUILTINS] = _LOAD_GLOBAL_BUILTINS__REG,
    [_LOAD_FROM_DICT_OR_DEREF] = _LOAD_FROM_DICT_OR_DEREF__REG,
    [_LOAD_DEREF] = _LOAD_DEREF__REG,
    [_STORE_DEREF] = _STORE_DEREF__REG,
    [_BUILD_STRING] = _BUILD_STRING__REG,
    [_BUILD_TUPLE] = _BUILD_TUPLE__REG,
    [_BUILD_LIST] = _BUILD_LIST__REG,
    [_LIST_EXTEND] = _LIST_EXTEND__REG,
    [_SET_UPDATE] = _SET_UPDATE__REG,
    [_BUILD_SET] = _BUILD_SET__REG,
    [_BUILD_MAP] = _BUILD_MAP__REG,
    [_BUILD_CONST_KEY_MAP] = _BUILD_CONST_KEY_MAP__REG,
    [_DICT_UPDATE] = _DICT_UPDATE__REG,
    [_DICT_MERGE] = _DICT_MERGE__REG,
    [_MAP_ADD] = _MAP_ADD__REG,
    [_LOAD_SUPER_ATTR_ATTR] = _LOAD_SUPER_ATTR_ATTR__REG,
    [_LOAD_SUPER_ATTR_METHOD] = _LOAD_SUPER_ATTR_METHOD__REG,
    [_LOAD_ATTR] = _LOAD_ATTR__REG,
    [_GUARD_TYPE_VERSION] = _GUARD_TYPE_VERSION__REG,
    [_CHECK_MANAGED_OBJECT_HAS_VALUES] = _CHECK_MANAGED_OBJECT_HAS_VALUES__REG,
    [_LOAD_ATTR_INSTANCE_VALUE_0] = _LOAD_ATTR_INSTANCE_VALUE_0__REG,
    [_LOAD_ATTR_INSTANCE_VALUE_1] = _LOAD_ATTR_INSTANCE_VALUE_1__REG,
    [_LOAD_ATTR_INSTANCE_VALUE] = _LOAD_ATTR_INSTANCE_VALUE__REG,
    [_CHECK_ATTR_MODULE] = _CHECK_ATTR_MODULE__REG,
    [_LOAD_ATTR_MODULE] = _LOAD_ATTR_MODULE__REG,
    [_CHECK_ATTR_WITH_HINT] = _CHECK_ATTR_WITH_HINT__REG,
    [_LOAD_ATTR_WITH_HINT] = _LOAD_ATTR_WITH_HINT__REG,
    [_LOAD_ATTR_SLOT_0] = _LOAD_ATTR_SLOT_0__REG,
    [_LOAD_ATTR_SLOT_1] = _LOAD_ATTR_SLOT_1__REG,
    [_LOAD_ATTR_SLOT] = _LOAD_ATTR_SLOT__REG,
    [_CHECK_ATTR_CLASS] = _CHECK_ATTR_CLASS__REG,
    [_LOAD_ATTR_CLASS_0] = _LOAD_ATTR_CLASS_0__REG,
    [_LOAD_ATTR_CLASS_1] = _LOAD_ATTR_CLASS_1__REG,
    [_LOAD_ATTR_CLASS] = _LOAD_ATTR_CLASS__REG,
    [_GUARD_DORV_VALUES] = _GUARD_DORV_VALUES__REG,
    [_STORE_ATTR_INSTANCE_VALUE] = _STORE_ATTR_INSTANCE_VALUE__REG,
    [_STORE_ATTR_SLOT] = _STORE_ATTR_SLOT__REG,
    [_COMPARE_OP] = _COMPARE_OP__REG,
    [_COMPARE_OP_FLOAT] = _COMPARE_OP_FLOAT__REG,
    [_COMPARE_OP_INT] = _COMPARE_OP_INT__REG,
    [_COMPARE_OP_STR] = _COMPARE_OP_STR__REG,
    [_IS_OP] = _IS_OP__REG,
    [_CONTAINS_OP] = _CONTAINS_OP__REG,
    [_CONTAINS_OP_SET] = _CONTAINS_OP_SET__REG,
    [_CONTAINS_OP_DICT] = _CONTAINS_OP_DICT__REG,
    [_CHECK_EG_MATCH] = _CHECK_EG_MATCH__REG,
    [_CHECK_EXC_MATCH] = _CHECK_EXC_MATCH__REG,
    [_IS_NONE] = _IS_NONE__REG,
    [_GET_LEN] = _GET_LEN__REG,
    [_MATCH_CLASS] = _MATCH_CLASS__REG,
    [_MATCH_MAPPING] = _MATCH_MAPPING__REG,
    [_MATCH_SEQUENCE] = _MATCH_SEQUENCE__REG,
    [_MATCH_KEYS] = _MATCH_KEYS__REG,
    [_GET_ITER] = _GET_ITER__REG,
    [_GET_YIELD_FROM_ITER] = _GET_YIELD_FROM_ITER__REG,
    [_FOR_ITER_TIER_TWO] = _FOR_ITER_TIER_TWO__REG,
    [_ITER_CHECK_LIST] = _ITER_CHECK_LIST__REG,
    [_GUARD_NOT_EXHAUSTED_LIST] = _GUARD_NOT_EXHAUSTED_LIST__REG,
    [_ITER_NEXT_LIST] = _ITER_NEXT_LIST__REG,
    [_ITER_CHECK_TUPLE] = _ITER_CHECK_TUPLE__REG,
    [_GUARD_NOT_EXHAUSTED_TUPLE] = _GUARD_NOT_EXHAUSTED_TUPLE__REG,
    [_ITER_NEXT_TUPLE] = _ITER_NEXT_TUPLE__REG,
    [_ITER_CHECK_RANGE] = _ITER_CHECK_RANGE__REG,
    [_GUARD_NOT_EXHAUSTED_RANGE] = _GUARD_NOT_EXHAUSTED_RANGE__REG,
    [_ITER_NEXT_RANGE] = _ITER_NEXT_RANGE__REG,
    [_BEFORE_ASYNC_WITH] = _BEFORE_ASYNC_WITH__REG,
    [_BEFORE_WITH] = _BEFORE_WITH__REG,
    [_WITH_EXCEPT_START] = _WITH_EXCEPT_START__REG,
    [_PUSH_EXC_INFO] = _PUSH_EXC_INFO__REG,
    [_GUARD_DORV_VALUES_INST_ATTR_FROM_DICT] = _GUARD_DORV_VALUES_INST_ATTR_FROM_DICT__REG,
    [_GUARD_KEYS_VERSION] = _GUARD_KEYS_VERSION__REG,
    [_LOAD_ATTR_METHOD_WITH_VALUES] = _LOAD_ATTR_METHOD_WITH_VALUES__REG,
    [_LOAD_ATTR_METHOD_NO_DICT] = _LOAD_ATTR_METHOD_NO_DICT__REG,
    [_LOAD_ATTR_NONDESCRIPTOR_WITH_VALUES] = _LOAD_ATTR_NONDESCRIPTOR_WITH_VALUES__REG,
    [_LOAD_ATTR_NONDESCRIPTOR_NO_DICT] = _LOAD_ATTR_NONDESCRIPTOR_NO_DICT__REG,
    [_CHECK_ATTR_METHOD_LAZY_DICT] = _CHECK_ATTR_METHOD_LAZY_DICT__REG,
    [_LOAD_ATTR_METHOD_LAZY_DICT] = _LOAD_ATTR_METHOD_LAZY_DICT__REG,
    [_CHECK_CALL_BOUND_METHOD_EXACT_ARGS] = _CHECK_CALL_BOUND_METHOD_EXACT_ARGS__REG,
    [_INIT_CALL_BOUND_METHOD_EXACT_ARGS] = _INIT_CALL_BOUND_METHOD_EXACT_ARGS__REG,
    [_CHECK_FUNCTION_EXACT_ARGS] = _CHECK_FUNCTION_EXACT_ARGS__REG,
    [_CHECK_STACK_SPACE] = _CHECK_STACK_SPACE__REG,
    [_INIT_CALL_PY_EXACT_ARGS_0] = _INIT_CALL_PY_EXACT_ARGS_0__REG,
    [_INIT_CALL_PY_EXACT_ARGS_1] = _INIT_CALL_PY_EXACT_ARGS_1__REG,
    [_INIT_CALL_PY_EXACT_ARGS_2] = _INIT_CALL_PY_EXACT_ARGS_2__REG,
    [_INIT_CALL_PY_EXACT_ARGS_3] = _INIT_CALL_PY_EXACT_ARGS_3__REG,
    [_INIT_CALL_PY_EXACT_ARGS_4] = _INIT_CALL_PY_EXACT_ARGS_4__REG,
    [_INIT_CALL_PY_EXACT_ARGS] = _INIT_CALL_PY_EXACT_ARGS__REG,
    [_PUSH_FRAME] = _PUSH_FRAME__REG,
    [_CALL_TYPE_1] = _CALL_TYPE_1__REG,
    [_CALL_STR_1] = _CALL_STR_1__REG,
    [_CALL_TUPLE_1] = _CALL_TUPLE_1__REG,
    [_EXIT_INIT_CHECK] = _EXIT_INIT_CHECK__REG,
    [_CALL_BUILTIN_CLASS] = _CALL_BUILTIN_CLASS__REG,
    [_CALL_BUILTIN_O] = _CALL_BUILTIN_O__REG,
    [_CALL_BUILTIN_FAST] = _CALL_BUILTIN_FAST__REG,
    [_CALL_BUILTIN_FAST_WITH_KEYWORDS] = _CALL_BUILTIN_FAST_WITH_KEYWORDS__REG,
    [_CALL_LEN] = _CALL_LEN__REG,
    [_CALL_ISINSTANCE] = _CALL_ISINSTANCE__REG,
    [_CALL_METHOD_DESCRIPTOR_O] = _CALL_METHOD_DESCRIPTOR_O__REG,
    [_CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS] = _CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS__REG,
    [_CALL_METHOD_DESCRIPTOR_NOARGS] = _CALL_METHOD_DESCRIPTOR_NOARGS__REG,
    [_CALL_METHOD_DESCRIPTOR_FAST] = _CALL_METHOD_DESCRIPTOR_FAST__REG,
    [_MAKE_FUNCTION] = _MAKE_FUNCTION__REG,
    [_SET_FUNCTION_ATTRIBUTE] = _SET_FUNCTION_ATTRIBUTE__REG,
    [_BUILD_SLICE] = _BUILD_SLICE__REG,
    [_CONVERT_VALUE] = _CONVERT_VALUE__REG,
    [_FORMAT_SIMPLE] = _FORMAT_SIMPLE__REG,
    [_FORMAT_WITH_SPEC] = _FORMAT_WITH_SPEC__REG,
    [_COPY] = _COPY__REG,
    [_BINARY_OP] = _BINARY_OP__REG,
    [_SWAP] = _SWAP__REG,
    [_GUARD_IS_TRUE_POP] = _GUARD_IS_TRUE_POP__REG,
    [_GUARD_IS_FALSE_POP] = _GUARD_IS_FALSE_POP__REG,
    [_GUARD_IS_NONE_POP] = _GUARD_IS_NONE_POP__REG,
    [_GUARD_IS_NOT_NONE_POP] = _GUARD_IS_NOT_NONE_POP__REG,
    [_LOAD_CONST_INLINE] = _LOAD_CONST_INLINE__REG,
    [_LOAD_CONST_INLINE_BORROW] = _LOAD_CONST_INLINE_BORROW__REG,
    [_POP_TOP_LOAD_CONST_INLINE_BORROW] = _POP_TOP_LOAD_CONST_INLINE_BORROW__REG,
    [_LOAD_CONST_INLINE_WITH_NULL] = _LOAD_CONST_INLINE_WITH_NULL__REG,
    [_LOAD_CONST_INLINE_BORROW_WITH_NULL] = _LOAD_CONST_INLINE_BORROW_WITH_NULL__REG,
    [_INTERNAL_INCREMENT_OPT_COUNTER] = _INTERNAL_INCREMENT_OPT_COUNTER__REG,
    [_REG_SPILL_0] = _REG_SPILL_0__REG,
    [_REG_SPILL_0_1] = _REG_SPILL_0_1__REG,
    [_REG_SPILL_0_1_2] = _REG_SPILL_0_1_2__REG,
};
