...
const uint32_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [LOAD_CONST] = HAS_ARG_FLAG | HAS_CONST_FLAG,
    [LOAD_CONST_MORTAL] = HAS_ARG_FLAG | HAS_CONST_FLAG,
    [LOAD_CONST_IMMORTAL] = HAS_ARG_FLAG | HAS_CONST_FLAG,
    [LOAD_SMALL_INT] = HAS_ARG_FLAG,
    [STORE_FAST] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_ESCAPES_FLAG,
    [STORE_FAST_LOAD_FAST] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_ESCAPES_FLAG,
    [STORE_FAST_STORE_FAST] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_ESCAPES_FLAG,
    [POP_TOP] = HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [PUSH_NULL] = HAS_PURE_FLAG,
    [END_FOR] = HAS_ESCAPES_FLAG | HAS_NO_SAVE_IP_FLAG,
    [INSTRUMENTED_END_FOR] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_NO_SAVE_IP_FLAG | HAS_TIER1_ONLY_FLAG,
    [INSTRUMENTED_POP_ITER] = HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [END_SEND] = HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [INSTRUMENTED_END_SEND] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [UNARY_NEGATIVE] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [UNARY_NOT] = HAS_PURE_FLAG,
    [TO_BOOL_BOOL] = HAS_EXIT_FLAG,
    [TO_BOOL_INT] = HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [TO_BOOL_LIST] = HAS_EXIT_FLAG,
    [TO_BOOL_NONE] = HAS_EXIT_FLAG,
    [TO_BOOL_STR] = HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [UNARY_INVERT] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [BINARY_OP_SUBSCR_LIST_INT] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [BINARY_OP_SUBSCR_STR_INT] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [BINARY_OP_SUBSCR_TUPLE_INT] = HAS_DEOPT_FLAG,
    [BINARY_OP_SUBSCR_DICT] = HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [LIST_APPEND] = HAS_ARG_FLAG | HAS_ERROR_FLAG,
    [SET_ADD] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [STORE_SUBSCR_LIST_INT] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    ...
    [RAISE_VARARGS] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [INTERPRETER_EXIT] = HAS_TIER1_ONLY_FLAG,
    [RETURN_VALUE] = HAS_ESCAPES_FLAG,
    ...
    [RERAISE] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [CLEANUP_THROW] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    ...
    [UNPACK_SEQUENCE_TWO_TUPLE] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    ...
    [MAKE_CELL] = HAS_ARG_FLAG | HAS_FREE_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    ...
    [BUILD_TUPLE] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG,
    [BUILD_LIST] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    ...
    [LOAD_SUPER_ATTR_METHOD] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    [LOAD_ATTR_GETATTRIBUTE_OVERRIDDEN] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_DEOPT_FLAG | HAS_TIER1_ONLY_FLAG,
    [IS_OP] = HAS_ARG_FLAG,
    ...
    [CHECK_EXC_MATCH] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    ...
    [JUMP_FORWARD] = HAS_ARG_FLAG | HAS_JUMP_FLAG | HAS_TIER1_ONLY_FLAG,
    [ENTER_EXECUTOR] = HAS_ARG_FLAG | HAS_TIER1_ONLY_FLAG,
    [JUMP_BACKWARD_NO_INTERRUPT] = HAS_ARG_FLAG | HAS_JUMP_FLAG | HAS_TIER1_ONLY_FLAG,
    ...
    [INSTRUMENTED_FOR_ITER] = HAS_ARG_FLAG | HAS_JUMP_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [LOAD_SPECIAL] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [WITH_EXCEPT_START] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [PUSH_EXC_INFO] = 0,
    [CALL_TYPE_1] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    ...
    [CALL_LIST_APPEND] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    ...
    [INSTRUMENTED_LINE] = HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [INSTRUMENTED_INSTRUCTION] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [INSTRUMENTED_JUMP_FORWARD] = HAS_ARG_FLAG | HAS_TIER1_ONLY_FLAG,
    [INSTRUMENTED_NOT_TAKEN] = HAS_TIER1_ONLY_FLAG,
    [INSTRUMENTED_POP_JUMP_IF_TRUE] = HAS_ARG_FLAG | HAS_TIER1_ONLY_FLAG,
    [INSTRUMENTED_POP_JUMP_IF_FALSE] = HAS_ARG_FLAG | HAS_TIER1_ONLY_FLAG,
    [INSTRUMENTED_POP_JUMP_IF_NONE] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [INSTRUMENTED_POP_JUMP_IF_NOT_NONE] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [EXTENDED_ARG] = HAS_ARG_FLAG | HAS_TIER1_ONLY_FLAG,
    [CACHE] = HAS_TIER1_ONLY_FLAG,
    [RESERVED] = HAS_TIER1_ONLY_FLAG,
    [NOT_TAKEN] = HAS_PURE_FLAG,
    [RESUME] = HAS_ARG_FLAG | HAS_EVAL_BREAK_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [INSTRUMENTED_RESUME] = HAS_ARG_FLAG | HAS_EVAL_BREAK_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [POP_ITER] = HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [TO_BOOL] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [TO_BOOL_ALWAYS_TRUE] = HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [BINARY_OP_MULTIPLY_INT] = HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [BINARY_OP_ADD_INT] = HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [BINARY_OP_SUBTRACT_INT] = HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    ...
    [BINARY_OP_EXTEND] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [BINARY_OP_INPLACE_ADD_UNICODE] = HAS_LOCAL_FLAG | HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [BINARY_SLICE] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [STORE_SLICE] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [BINARY_OP_SUBSCR_GETITEM] = HAS_DEOPT_FLAG,
    [STORE_SUBSCR] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [INSTRUMENTED_RETURN_VALUE] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [SEND] = HAS_ARG_FLAG | HAS_JUMP_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [SEND_GEN] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    [INSTRUMENTED_YIELD_VALUE] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [INSTRUMENTED_END_ASYNC_FOR] = HAS_ARG_FLAG | HAS_JUMP_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [END_ASYNC_FOR] = HAS_ARG_FLAG | HAS_JUMP_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [UNPACK_SEQUENCE] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [STORE_ATTR] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [LOAD_GLOBAL] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [LOAD_GLOBAL_MODULE] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    [LOAD_GLOBAL_BUILTIN] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    [INSTRUMENTED_LOAD_SUPER_ATTR] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [LOAD_SUPER_ATTR] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [LOAD_ATTR] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [LOAD_ATTR_INSTANCE_VALUE] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [LOAD_ATTR_MODULE] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [LOAD_ATTR_WITH_HINT] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    ...
    [STORE_ATTR_INSTANCE_VALUE] = HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [STORE_ATTR_WITH_HINT] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [STORE_ATTR_SLOT] = HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [COMPARE_OP] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    ...
    [CONTAINS_OP] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [JUMP_BACKWARD] = HAS_ARG_FLAG | HAS_JUMP_FLAG | HAS_EVAL_BREAK_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [JUMP_BACKWARD_NO_JIT] = HAS_ARG_FLAG | HAS_JUMP_FLAG | HAS_EVAL_BREAK_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [JUMP_BACKWARD_JIT] = HAS_ARG_FLAG | HAS_JUMP_FLAG | HAS_EVAL_BREAK_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    ...
    [FOR_ITER] = HAS_ARG_FLAG | HAS_JUMP_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [FOR_ITER_LIST] = HAS_ARG_FLAG | HAS_JUMP_FLAG | HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [FOR_ITER_TUPLE] = HAS_ARG_FLAG | HAS_JUMP_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    ...
    [LOAD_ATTR_NONDESCRIPTOR_WITH_VALUES] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [LOAD_ATTR_NONDESCRIPTOR_NO_DICT] = HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [LOAD_ATTR_METHOD_LAZY_DICT] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_EXIT_FLAG,
    [CALL] = HAS_ARG_FLAG | HAS_EVAL_BREAK_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [INSTRUMENTED_CALL] = HAS_ARG_FLAG | HAS_EVAL_BREAK_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    ...
    [CALL_BOUND_METHOD_EXACT_ARGS] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    ...
    [CALL_KW_PY] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [CALL_KW_BOUND_METHOD] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [CALL_KW] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [INSTRUMENTED_CALL_KW] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    [CALL_KW_NON_PY] = HAS_ARG_FLAG | HAS_EVAL_BREAK_FLAG | HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [CALL_FUNCTION_EX] = HAS_EVAL_BREAK_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [INSTRUMENTED_CALL_FUNCTION_EX] = HAS_EVAL_BREAK_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
    [BINARY_OP] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_TIER1_ONLY_FLAG,
