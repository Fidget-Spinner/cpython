...
const uint32_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_JUMP_TO_TOP] = 0,
    [_PEELED_LOOP_START] = HAS_DEOPT_FLAG,
    [_JUMP_TO_PEELED_LOOP] = 0,
    [_SET_IP] = 0,
...
const _PyUopCachingInfo _PyUop_Caching[MAX_UOP_ID+1] = {
    ...
    [_PEELED_LOOP_START] = {
        ...
        .entries = {
            ...
            { 1, 1, _PEELED_LOOP_START_r11 },
            { 2, 2, _PEELED_LOOP_START_r22 },
            { 3, 3, _PEELED_LOOP_START_r33 },
        },
    },
    [_JUMP_TO_PEELED_LOOP] = {
        ...
        .entries = {
            ...
            { 1, 1, _JUMP_TO_PEELED_LOOP_r11 },
            { 2, 2, _JUMP_TO_PEELED_LOOP_r22 },
            { 3, 3, _JUMP_TO_PEELED_LOOP_r33 },
        },
    },
    [_SET_IP] = {
        .best = { 0, 1, 2, 3 },
...
const uint16_t _PyUop_Uncached[MAX_UOP_REGS_ID+1] = {
    ...
    [_PEELED_LOOP_START_r11] = _PEELED_LOOP_START,
    [_PEELED_LOOP_START_r22] = _PEELED_LOOP_START,
    [_PEELED_LOOP_START_r33] = _PEELED_LOOP_START,
    [_JUMP_TO_PEELED_LOOP_r00] = _JUMP_TO_PEELED_LOOP,
    [_JUMP_TO_PEELED_LOOP_r11] = _JUMP_TO_PEELED_LOOP,
    [_JUMP_TO_PEELED_LOOP_r22] = _JUMP_TO_PEELED_LOOP,
    [_JUMP_TO_PEELED_LOOP_r33] = _JUMP_TO_PEELED_LOOP,
    [_SET_IP_r00] = _SET_IP,
    [_SET_IP_r11] = _SET_IP,
    [_SET_IP_r22] = _SET_IP,
    [_SET_IP_r33] = _SET_IP,
...
const char *const _PyOpcode_uop_name[MAX_UOP_REGS_ID+1] = {
    ...
    [_JUMP_TO_PEELED_LOOP_r11] = "_JUMP_TO_PEELED_LOOP_r11",
    [_JUMP_TO_PEELED_LOOP_r22] = "_JUMP_TO_PEELED_LOOP_r22",
    [_JUMP_TO_PEELED_LOOP_r33] = "_JUMP_TO_PEELED_LOOP_r33",
    ...
    [_PEELED_LOOP_START_r11] = "_PEELED_LOOP_START_r11",
    [_PEELED_LOOP_START_r22] = "_PEELED_LOOP_START_r22",
    [_PEELED_LOOP_START_r33] = "_PEELED_LOOP_START_r33",
    [_POP_CALL] = "_POP_CALL",
