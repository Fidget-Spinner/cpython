...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_CHECK_INIT_MATCHES_VERSIONS] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    ...
    [_CHECK_FUNCTION_INLINE] = HAS_DEOPT_FLAG,
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_CHECK_FUNCTION_INLINE] = "_CHECK_FUNCTION_INLINE",
    ...
    [_CHECK_INIT_MATCHES_VERSIONS] = "_CHECK_INIT_MATCHES_VERSIONS",
