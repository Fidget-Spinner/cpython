...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_BINARY_OP_MULTIPLY_TAGGED_INT] = "_BINARY_OP_MULTIPLY_TAGGED_INT",
    ...
    [_BINARY_OP_SUBTRACT_TAGGED_INT] = "_BINARY_OP_SUBTRACT_TAGGED_INT",
    [_BINARY_SLICE] = "_BINARY_SLICE",
    [_BOX_TAGGED_INT_CURR_FRAME] = "_BOX_TAGGED_INT_CURR_FRAME",
    [_BOX_TAGGED_INT_CURR_FRAME_1] = "_BOX_TAGGED_INT_CURR_FRAME_1",
    [_BOX_TAGGED_INT_CURR_FRAME_2] = "_BOX_TAGGED_INT_CURR_FRAME_2",
...
int _PyUop_num_popped(int opcode, int oparg)
{
    switch(opcode) {
        ...
        case _BINARY_OP_ADD_TAGGED_INT:
            return 2;
        case _BOX_TAGGED_INT_CURR_FRAME_1:
            return 0;
