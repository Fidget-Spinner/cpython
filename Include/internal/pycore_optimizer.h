...
extern void _Py_uop_sym_set_unboxed(_Py_UOpsContext *ctx, _Py_UopsSymbol *sym);
extern void _Py_uop_sym_set_boxed(_Py_UOpsContext *ctx, _Py_UopsSymbol *sym);
extern bool _Py_uop_sym_is_boxed(_Py_UopsSymbol *sym);
extern bool _Py_uop_sym_is_unboxed(_Py_UopsSymbol *sym);
