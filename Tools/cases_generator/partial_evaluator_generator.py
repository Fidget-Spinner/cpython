...
from optimizer_generator import validate_uop

DEFAULT_OUTPUT = ROOT / "Python/partial_evaluator.cases.c.h"
...
def write_uop(
    ...
    try:
        ...
        if override:
            ...
            out.start_line()
            stack.flush(out)
            out.emit("COPY_TO_TRACE(this_instr);\n")
