...
_HOLE_EXPRS = {
    ...
    # HoleValue.GOT: "",
    HoleValue.OPARG0: "instruction[0].oparg",
    HoleValue.OPERAND0_0: "instruction[0].operand0",
    HoleValue.OPERAND1_0: "instruction[0].operand1",

    HoleValue.OPARG1: "instruction[1].oparg",
    HoleValue.OPERAND0_1: "instruction[1].operand0",
    HoleValue.OPERAND1_1: "instruction[1].operand1",

    HoleValue.OPARG2: "instruction[2].oparg",
    HoleValue.OPERAND0_2: "instruction[2].operand0",
    HoleValue.OPERAND1_2: "instruction[2].operand1",

    HoleValue.OPARG3: "instruction[3].oparg",
    HoleValue.OPERAND0_3: "instruction[3].operand0",
    HoleValue.OPERAND1_3: "instruction[3].operand1",

    HoleValue.OPARG4: "instruction[4].oparg",
    HoleValue.OPERAND0_4: "instruction[4].operand0",
    HoleValue.OPERAND1_4: "instruction[4].operand1",

    HoleValue.OPARG5: "instruction[5].oparg",
    HoleValue.OPERAND0_5: "instruction[5].operand0",
    HoleValue.OPERAND1_5: "instruction[5].operand1",

    HoleValue.OPARG6: "instruction[6].oparg",
    HoleValue.OPERAND0_6: "instruction[6].operand0",
    HoleValue.OPERAND1_6: "instruction[6].operand1",

    HoleValue.OPARG7: "instruction[7].oparg",
    HoleValue.OPERAND0_7: "instruction[7].operand0",
    HoleValue.OPERAND1_7: "instruction[7].operand1",

    HoleValue.OPARG8: "instruction[8].oparg",
    HoleValue.OPERAND0_8: "instruction[8].operand0",
    HoleValue.OPERAND1_8: "instruction[8].operand1",
    ...
    HoleValue.TARGET0: "instruction[0].target",
    HoleValue.JUMP_TARGET0: "state->instruction_starts[instruction[0].jump_target]",
    HoleValue.ERROR_TARGET0: "state->instruction_starts[instruction[0].error_target]",

    HoleValue.TARGET1: "instruction[1].target",
    HoleValue.JUMP_TARGET1: "state->instruction_starts[instruction[1].jump_target]",
    HoleValue.ERROR_TARGET1: "state->instruction_starts[instruction[1].error_target]",

    HoleValue.TARGET2: "instruction[2].target",
    HoleValue.JUMP_TARGET2: "state->instruction_starts[instruction[2].jump_target]",
    HoleValue.ERROR_TARGET2: "state->instruction_starts[instruction[2].error_target]",

    HoleValue.TARGET3: "instruction[3].target",
    HoleValue.JUMP_TARGET3: "state->instruction_starts[instruction[3].jump_target]",
    HoleValue.ERROR_TARGET3: "state->instruction_starts[instruction[3].error_target]",

    HoleValue.TARGET4: "instruction[4].target",
    HoleValue.JUMP_TARGET4: "state->instruction_starts[instruction[4].jump_target]",
    HoleValue.ERROR_TARGET4: "state->instruction_starts[instruction[4].error_target]",

    HoleValue.TARGET5: "instruction[5].target",
    HoleValue.JUMP_TARGET5: "state->instruction_starts[instruction[5].jump_target]",
    HoleValue.ERROR_TARGET5: "state->instruction_starts[instruction[5].error_target]",

    HoleValue.TARGET6: "instruction[6].target",
    ...
    HoleValue.TARGET7: "instruction[7].target",
    HoleValue.JUMP_TARGET7: "state->instruction_starts[instruction[7].jump_target]",
    HoleValue.ERROR_TARGET7: "state->instruction_starts[instruction[7].error_target]",

    HoleValue.TARGET8: "instruction[8].target",
    HoleValue.JUMP_TARGET8: "state->instruction_starts[instruction[8].jump_target]",
    HoleValue.ERROR_TARGET8: "state->instruction_starts[instruction[8].error_target]",
