...
do {                                                                       \
    ...
    __attribute__((musttail)) return jitted(frame, stack_pointer, tstate, PYOBJECT_SCRATCH); \
} while (0)
...
do {                                                                     \
    ...
    __attribute__((musttail)) return jump(frame, stack_pointer, tstate, PYOBJECT_SCRATCH); \
} while (0)
